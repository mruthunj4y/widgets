...
import { ChainId, TradeType, Currency, Percent, CurrencyAmount, Token } from '@surge/sdk-core';
...
declare function Logo({ currency, symbol, backupImg, size, style, ...rest }: LogoProps): react_jsx_runtime.JSX.Element;

interface SwapWidgetSkeletonProps {
    theme?: Theme;
    width?: string | number;
}
declare function SwapWidgetSkeleton({ theme, width }: SwapWidgetSkeletonProps): react_jsx_runtime.JSX.Element;
...
declare function SwapWidget(props: SwapWidgetProps): react_jsx_runtime.JSX.Element;
