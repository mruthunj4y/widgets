...
var _extends$d = require('@babel/runtime/helpers/extends');
...
var invariant$2 = require('tiny-invariant');
var units = require('@ethersproject/units');
var JSBI = require('jsbi');
var toolkit = require('@reduxjs/toolkit');
var jotai = require('jotai');
var routerSdk = require('@surge/router-sdk');
var v2Sdk = require('@surge/v2-sdk');
var v3Sdk = require('@surge/v3-sdk');
var qs = require('qs');
var abi$1 = require('@ethersproject/abi');
var reduxMulticall = require('@surge/redux-multicall');
var address = require('@ethersproject/address');
var constants = require('@ethersproject/constants');
var require$$3 = require('@ethersproject/contracts');
var require$$1 = require('@ethersproject/hash');
var require$$2 = require('@ethersproject/bignumber');
var signing = require('@surge/conedison/provider/signing');
var format = require('@surge/conedison/format');
...
var index = require('@surge/conedison/provider/index');
var universalRouterSdk = require('@surge/universal-router-sdk');
...
var invariant__default = /*#__PURE__*/_interopDefaultLegacy(invariant$2);
...
const LinguiContext = /*#__PURE__*/React__default["default"].createContext(null);
function useLingui() {
...
const I18nProvider = _ref => {
  ...
  const [context, setContext] = React__default["default"].useState(makeContext()),
    [renderKey, setRenderKey] = React__default["default"].useState(getRenderKey());
...
function Trans(props) {
  ...
  const FallbackComponent = defaultComponent || React__default["default"].Fragment;
  const i18nProps = {
    id,
    message,
    translation,
  ...
  if (render && component) {
    ...
    return /*#__PURE__*/React__default["default"].createElement(FallbackComponent, i18nProps, translation);
  }
  ...
  return DefaultComponent && !component ? /*#__PURE__*/React__default["default"].createElement(DefaultComponent, i18nProps, translation) : /*#__PURE__*/React__default["default"].createElement(Component, null, translation);
}
Trans.defaultProps = {
  values: {},
  components: {}
...
const Row = styled__default["default"].div(_templateObject$S || (_templateObject$S = _taggedTemplateLiteral__default["default"](["\n  align-items: ", ";\n  color: ", ";\n  display: ", ";\n  flex-flow: ", ";\n  flex-grow: ", ";\n  gap: ", ";\n  grid-auto-flow: column;\n  grid-template-columns: ", ";\n  justify-content: ", ";\n  padding: ", ";\n"])), _ref => {
  let {
    align
  } = _ref;
...
const SvgCheck = props => /*#__PURE__*/React__default["default"].createElement("svg", _extends$c({
  viewBox: "0 0 20 20",
  fill: "none",
  ...
  cy: 10,
  r: 10
})), _path$7 || (_path$7 = /*#__PURE__*/React__default["default"].createElement("path", {
...
const SvgExpando = props => /*#__PURE__*/React__default["default"].createElement("svg", _extends$b({
  viewBox: "0 0 24 24",
  fill: "none",
  strokeWidth: 2,
  strokeLinecap: "round",
...
const SvgGasIcon = props => /*#__PURE__*/React__default["default"].createElement("svg", _extends$a({
  width: 16,
  height: 16,
  viewBox: "0 0 16 16",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, props), _path$6 || (_path$6 = /*#__PURE__*/React__default["default"].createElement("path", {
  strokeWidth: "0.1px",
...
const SvgLargeArrow = props => /*#__PURE__*/React__default["default"].createElement("svg", _extends$9({
  width: 90,
  height: 90,
  viewBox: "0 0 90 90",
  fill: "none",
...
const SvgLargeCheck = props => /*#__PURE__*/React__default["default"].createElement("svg", _extends$8({
  width: 64,
  height: 46,
  viewBox: "0 0 64 46",
  fill: "none",
...
const SvgLargeSpinner = props => /*#__PURE__*/React__default["default"].createElement("svg", _extends$7({
  width: 94,
  height: 94,
  viewBox: "0 0 94 94",
  fill: "none",
...
const SvgLogo = props => /*#__PURE__*/React__default["default"].createElement("svg", _extends$6({
  viewBox: "0 0 14 15",
  fill: "black",
  xmlns: "http://www.w3.org/2000/svg"
...
const SvgReverse = props => /*#__PURE__*/React__default["default"].createElement("svg", _extends$5({
  width: 14,
  height: 20,
  viewBox: "0 0 14 20",
  fill: "none",
...
const SvgSpinner = props => /*#__PURE__*/React__default["default"].createElement("svg", _extends$4({
  viewBox: "0 0 24 24",
  xmlns: "http://www.w3.org/2000/svg"
...
const SvgWallet = props => /*#__PURE__*/React__default["default"].createElement("svg", _extends$3({
  width: 24,
  height: 24,
  viewBox: "0 0 24 24",
  fill: "none",
...
const SvgWalletDisconnect = props => /*#__PURE__*/React__default["default"].createElement("svg", _extends$2({
  width: 16,
  height: 16,
  viewBox: "0 0 16 16",
  fill: "none",
...
const iconHoverCss = styled.css(_templateObject$R || (_templateObject$R = _taggedTemplateLiteral__default["default"](["\n  :hover {\n    cursor: pointer;\n    opacity: 0.6;\n  }\n"])));
...
const fadeIn = styled.keyframes(_templateObject$Q || (_templateObject$Q = _taggedTemplateLiteral__default["default"](["\n  from {\n    opacity: 0;\n  }\n  to {\n    opacity: 1;\n  }\n"])));
const fadeOut = styled.keyframes(_templateObject2$A || (_templateObject2$A = _taggedTemplateLiteral__default["default"](["\n  to {\n    opacity: 0;\n  }\n  from {\n    opacity: 1;\n  }\n"])));
const fadeAnimationCss = styled.css(_templateObject3$n || (_templateObject3$n = _taggedTemplateLiteral__default["default"](["\n  animation: ", " ", " ease-in-out;\n  &.", " {\n    animation: ", " ", " ease-in-out;\n  }\n"])), fadeIn, AnimationSpeed.Medium, SlideAnimationType.CLOSING, fadeOut, AnimationSpeed.Medium);
...
function getDynamicTheme(theme, color) {
  ...
  return _objectSpread$k(_objectSpread$k(_objectSpread$k({}, theme), colors), {}, {
    module: color,
    onHover: color => color === colors.primary ? polished.transparentize(0.4, colors.primary) : polished.opacify(0.25, color)
  });
}
function getAccessibleColor(theme, color) {
  ...
  let AAscore = wcagContrast.hex(color, primary);
  const contrastify = wcagContrast.hex(color, '#000') > wcagContrast.hex(color, '#fff') ? polished.darken : polished.lighten;
  while (AAscore < 3) {
...
const TransitionTextWrapper = styled__default["default"](TextWrapper)(_templateObject2$z || (_templateObject2$z = _taggedTemplateLiteral__default["default"](["\n  transition: font-size ", " ease-out, line-height ", " ease-out;\n"])), AnimationSpeed.Medium, AnimationSpeed.Medium);
function H1(props) {
...
const ThemeContext = /*#__PURE__*/React.createContext(toDefaultTheme(defaultTheme));
...
function toDefaultTheme(theme) {
  return _objectSpread$j(_objectSpread$j({}, theme), {}, {
    ...
    onHover: color => color === theme.primary ? polished.transparentize(0.4, theme.primary) : polished.mix(0.06, theme.primary, color)
  });
...
function AutoRouterIcon(_ref) {
  ...
  const componentIdRef = React.useRef(id !== null && id !== void 0 ? id : getUniqueId());
...
function IdenticonIcon() {
  ...
  const iconSrc = React.useMemo(() => account && getGradientIconSrc(account), [account]);
...
function icon(Icon) {
  return styled__default["default"](Icon)(_templateObject$O || (_templateObject$O = _taggedTemplateLiteral__default["default"](["\n    clip-path: stroke-box;\n    height: 1em;\n    stroke: ", ";\n    width: 1em;\n  "])), _ref => {
    let {
      color = 'currentColor',
      theme
    } = _ref;
...
const largeIconCss = styled.css(_templateObject2$y || (_templateObject2$y = _taggedTemplateLiteral__default["default"](["\n  display: flex;\n\n  svg {\n    align-self: center;\n    height: ", "em;\n    width: ", "em;\n  }\n"])), _ref2 => {
  let {
    iconSize
  } = _ref2;
  return iconSize;
...
const LargeWrapper = styled__default["default"].div(_templateObject3$m || (_templateObject3$m = _taggedTemplateLiteral__default["default"](["\n  height: ", "em;\n  width: ", "em;\n  ", "\n"])), _ref4 => {
  let {
    iconSize
  } = _ref4;
  return iconSize;
...
const AlertTriangle = icon(reactFeather.AlertTriangle);
const ArrowDown = icon(reactFeather.ArrowDown);
const ArrowRight = icon(reactFeather.ArrowRight);
const ArrowLeft = icon(reactFeather.ArrowLeft);
icon(reactFeather.ArrowUp);
icon(reactFeather.BarChart2);
const ChevronDown = icon(reactFeather.ChevronDown);
icon(reactFeather.ChevronUp);
icon(reactFeather.Clock);
const HelpCircle = icon(reactFeather.HelpCircle);
icon(IdenticonIcon);
const Info = icon(reactFeather.Info);
const Link = icon(reactFeather.ArrowUpRight);
const AutoRouter = icon(AutoRouterIcon);
const Settings$1 = icon(reactFeather.Settings);
icon(reactFeather.Slash);
icon(reactFeather.Trash2);
icon(SvgWallet);
const X = icon(reactFeather.X);
icon(reactFeather.XOctagon);
icon(SvgReverse);
const Search = icon(reactFeather.Search);
styled__default["default"](icon(SvgCheck))(_templateObject4$b || (_templateObject4$b = _taggedTemplateLiteral__default["default"](["\n  circle {\n    fill: ", ";\n    stroke: none;\n  }\n"])), _ref7 => {
  let {
    theme,
    color
  } = _ref7;
...
const Expando$1 = styled__default["default"](icon(SvgExpando))(_templateObject5$8 || (_templateObject5$8 = _taggedTemplateLiteral__default["default"](["\n  transform: ", ";\n  transition: transform ", ";\n"])), _ref8 => {
  let {
    open
  } = _ref8;
  return open ? 'rotate(0deg)' : 'rotate(-180deg)';
}, AnimationSpeed.Medium);
const Logo$1 = styled__default["default"](icon(SvgLogo))(_templateObject6$7 || (_templateObject6$7 = _taggedTemplateLiteral__default["default"](["\n  fill: ", ";\n  stroke: none;\n"])), _ref9 => {
  let {
    theme
  } = _ref9;
  return theme.secondary;
});
const WalletDisconnect = styled__default["default"](icon(SvgWalletDisconnect))(_templateObject7$7 || (_templateObject7$7 = _taggedTemplateLiteral__default["default"](["\n  fill: currentColor;\n  stroke: none;\n"])));
const rotate = styled.keyframes(_templateObject8$2 || (_templateObject8$2 = _taggedTemplateLiteral__default["default"](["\n  from {\n    transform: rotate(-45deg);\n  }\n  to {\n    transform: rotate(315deg);\n  }\n"])));
const Spinner = styled__default["default"](icon(SvgSpinner))(_templateObject9$1 || (_templateObject9$1 = _taggedTemplateLiteral__default["default"](["\n  animation: ", " 1s cubic-bezier(0.83, 0, 0.17, 1) infinite;\n  color: ", ";\n  fill: ", ";\n  transition: color ", "ms ease, fill ", "ms ease;\n  #dot {\n    fill: ", ";\n  }\n"])), rotate, _ref0 => {
  let {
    color = 'active',
    theme
  } = _ref0;
...
styled__default["default"](icon(SvgLargeCheck))(_templateObject0$1 || (_templateObject0$1 = _taggedTemplateLiteral__default["default"](["\n  stroke: ", ";\n"])), _ref11 => {
  let {
    color = 'primary',
    theme
  } = _ref11;
...
const LargeAlert = styled__default["default"](LargeIcon).attrs({
  icon: reactFeather.AlertTriangle,
  color: 'error',
  size: 6,
  strokeWidth: 1
})(_templateObject1$1 || (_templateObject1$1 = _taggedTemplateLiteral__default["default"]([""])));
styled__default["default"](icon(SvgLargeSpinner))(_templateObject10$1 || (_templateObject10$1 = _taggedTemplateLiteral__default["default"](["\n  animation: 2s ", " linear infinite;\n  stroke: ", ";\n"])), rotate, _ref12 => {
  let {
    color = 'primary',
    theme
  } = _ref12;
...
styled__default["default"](icon(SvgLargeArrow))(_templateObject11$1 || (_templateObject11$1 = _taggedTemplateLiteral__default["default"](["\n  stroke: ", ";\n"])), _ref13 => {
  let {
    color = 'primary',
    theme
  } = _ref13;
...
const Gas = styled__default["default"](icon(SvgGasIcon))(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral__default["default"](["\n  fill: ", ";\n  stroke: ", ";\n"])), _ref14 => {
  let {
    color = 'active',
    theme
  } = _ref14;
...
const StyledXButton = styled__default["default"](X)(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral__default["default"](["\n  ", "\n  stroke-width: 2.5px;\n"])), iconHoverCss);
...
const UniswapA = styled__default["default"](ExternalLink)(_templateObject$N || (_templateObject$N = _taggedTemplateLiteral__default["default"](["\n  color: ", ";\n  cursor: pointer;\n  text-decoration: none;\n\n  ", " {\n    fill: ", ";\n    height: 1rem;\n    transition: transform ", " ease, fill ", " ease;\n    width: 1rem;\n    will-change: transform;\n  }\n\n  :hover ", " {\n    fill: ", ";\n    transform: rotate(-5deg);\n  }\n"])), _ref => {
  let {
    theme
  } = _ref;
  return theme.secondary;
...
const Wrapper$1 = styled__default["default"](Row)(_templateObject2$x || (_templateObject2$x = _taggedTemplateLiteral__default["default"](["\n  margin-top: 12px;\n"])));
var BrandedFooter = /*#__PURE__*/React.memo(function BrandedFooter() {
  return /*#__PURE__*/React__default["default"].createElement(Wrapper$1, {
    ...
    gap: 0.25
  }, /*#__PURE__*/React__default["default"].createElement(Logo$1, null), /*#__PURE__*/React__default["default"].createElement(Caption$1, null, /*#__PURE__*/React__default["default"].createElement(Trans, {
...
const BaseButton = styled__default["default"].button(_templateObject$M || (_templateObject$M = _taggedTemplateLiteral__default["default"](["\n  background-color: transparent;\n  border: none;\n  border-radius: 0.5rem;\n  color: currentColor;\n  cursor: pointer;\n  font-size: inherit;\n  font-weight: inherit;\n  height: inherit;\n  line-height: inherit;\n  margin: 0;\n  padding: 0;\n\n  :enabled {\n    transition: filter ", " linear;\n  }\n\n  :disabled {\n    cursor: initial;\n    filter: opacity(0.6);\n  }\n"])), AnimationSpeed.Fast);
var Button$1 = styled__default["default"](BaseButton)(_templateObject2$w || (_templateObject2$w = _taggedTemplateLiteral__default["default"](["\n  background-color: ", ";\n  border: 1px solid transparent;\n  color: ", ";\n\n  :enabled:hover {\n    background-color: ", ";\n  }\n"])), _ref => {
  let {
    color = 'interactive',
    theme
  } = _ref;
...
const transparentButton = defaultColor => styled__default["default"](BaseButton)(_templateObject3$l || (_templateObject3$l = _taggedTemplateLiteral__default["default"](["\n  color: ", ";\n\n  :enabled:hover {\n    color: ", ";\n    * {\n      color: ", ";\n    }\n  }\n"])), _ref4 => {
  let {
    color = defaultColor,
    theme
  } = _ref4;
...
const IconButton = /*#__PURE__*/React.forwardRef(function IconButton(_ref7, ref) {
  let {
      icon,
      iconProps
    } = _ref7,
    props = _objectWithoutProperties__default["default"](_ref7, _excluded$6);
...
const AccountButton = styled__default["default"](TextButton)(_templateObject$L || (_templateObject$L = _taggedTemplateLiteral__default["default"](["\n  filter: none;\n  visibility: ", ";\n"])), _ref => {
  let {
    hidden
  } = _ref;
...
const BlockNumberContext = /*#__PURE__*/React.createContext(MISSING_PROVIDER$1);
function useBlockNumberContext() {
  const blockNumber = React.useContext(BlockNumberContext);
...
function Provider$7(_ref) {
  ...
  const [{
    chainId,
    block
  }, setChainBlock] = React.useState({
    chainId: activeChainId
  });
  const onBlock = React.useCallback(block => {
...
const oldestBlockMapAtom = immer.atomWithImmer({});
const DEFAULT_MAX_BLOCK_AGE = 10;
function useSetOldestValidBlock() {
  const {
    chainId
  } = core.useWeb3React();
  const updateValidBlock = utils.useUpdateAtom(oldestBlockMapAtom);
  return React.useCallback(block => {
    if (!chainId) return;
...
function useGetIsValidBlock() {
  ...
  const oldestBlockMap = utils.useAtomValue(oldestBlockMapAtom);
...
const WETH_XRPL_EVM_TESTNET = new sdkCore.Token(SupportedChainId.XRPL_EVM_TESTNET, XRPL_EVM_TESTNET_WETH_ADDRESS, 18, 'WETH', 'Wrapped Ether');
const BNB_XRPL_EVM_TESTNET = new sdkCore.Token(SupportedChainId.XRPL_EVM_TESTNET, XRPL_EVM_TESTNET_BNB_ADDRESS, 18, 'BNB', 'Binance Coin');
const USDT_XRPL_EVM_TESTNET = new sdkCore.Token(SupportedChainId.XRPL_EVM_TESTNET, XRPL_EVM_TESTNET_USDT_ADDRESS, 6, 'USDT', 'Tether USD');
const AVAX_XRPL_EVM_TESTNET = new sdkCore.Token(SupportedChainId.XRPL_EVM_TESTNET, XRPL_EVM_TESTNET_AVAX_ADDRESS, 18, 'AVAX', 'Avalanche');
const AXL_XRPL_EVM_TESTNET = new sdkCore.Token(SupportedChainId.XRPL_EVM_TESTNET, XRPL_EVM_TESTNET_AXL_ADDRESS, 18, 'AXL', 'AXL Token');
const MATIC_XRPL_EVM_TESTNET = new sdkCore.Token(SupportedChainId.XRPL_EVM_TESTNET, XRPL_EVM_TESTNET_MATIC_ADDRESS, 18, 'MATIC', 'Polygon');
const RLUSD_XRPL_EVM_TESTNET = new sdkCore.Token(SupportedChainId.XRPL_EVM_TESTNET, XRPL_EVM_TESTNET_RLUSD_ADDRESS, 18, 'RLUSD', 'Ripple USD');
const USDC_XRPL_EVM_TESTNET = new sdkCore.Token(SupportedChainId.XRPL_EVM_TESTNET, XRPL_EVM_TESTNET_USDC_ADDRESS, 6, 'USDC', 'USD Coin');
const SOL_XRPL_EVM_TESTNET = new sdkCore.Token(SupportedChainId.XRPL_EVM_TESTNET, XRPL_EVM_TESTNET_SOL_ADDRESS, 9, 'SOL', 'Solana');
const DAI_XRPL_EVM_TESTNET = new sdkCore.Token(SupportedChainId.XRPL_EVM_TESTNET, XRPL_EVM_TESTNET_DAI_ADDRESS, 18, 'DAI', 'Dai Stablecoin');
const TON_XRPL_EVM_TESTNET = new sdkCore.Token(SupportedChainId.XRPL_EVM_TESTNET, XRPL_EVM_TESTNET_TON_ADDRESS, 18, 'TON', 'Ton Coin');
const TRON_XRPL_EVM_TESTNET = new sdkCore.Token(SupportedChainId.XRPL_EVM_TESTNET, XRPL_EVM_TESTNET_TRON_ADDRESS, 6, 'TRX', 'Tron');
const WXRP_XRPL_EVM_TESTNET = new sdkCore.Token(SupportedChainId.XRPL_EVM_TESTNET, XRPL_EVM_TESTNET_WXRP_ADDRESS, 18, 'WXRP', 'Wrapped XRP');
...
class XrplNativeCurrency extends sdkCore.NativeCurrency {
  equals(other) {
  ...
  get wrapped() {
    ...
    invariant__default["default"](wrapped instanceof sdkCore.Token, '[XrplNativeCurrency.wrapped] wrapped token not valid');
    return wrapped;
  }
  constructor(chainId) {
...
const STABLECOIN_AMOUNT_OUT = {
  [SupportedChainId.XRPL_EVM_TESTNET]: sdkCore.CurrencyAmount.fromRawAmount(USDC_XRPL_EVM_TESTNET, 100000e6)
};
...
const controlledAtom$1 = jotai.atom(undefined);
const stateAtom$1 = immer.atomWithImmer(initialSwap);
const swapAtom = jotai.atom(get => {
...
const displayTxHashAtom = jotai.atom(undefined);
const feeOptionsAtom = jotai.atom(undefined);
...
const swapEventHandlersAtom = jotai.atom({});
const swapRouterUrlAtom = jotai.atom(undefined);
...
class InterfaceTrade extends routerSdk.Trade {}
...
function useGetQuoteArgs(_ref2, quoteConfig) {
  ...
  const routerUrl = utils.useAtomValue(swapRouterUrlAtom);
  const {
    onSwapQuote
  } = utils.useAtomValue(swapEventHandlersAtom);
  ...
  return {
    plural: (value, _ref) => {
      let {
        ...
        rules = _objectWithoutProperties__default["default"](_ref, _excluded$5);
    ...
    selectordinal: (value, _ref2) => {
      let {
        ...
        rules = _objectWithoutProperties__default["default"](_ref2, _excluded2$1);
...
class EventEmitter {
  constructor() {
    _defineProperty__default["default"](this, "_events", {});
  }
  on(event, listener) {
...
class WidgetError extends Error {
  constructor(config) {
    ...
    _defineProperty__default["default"](this, "dismissable", false);
...
const protocols = [routerSdk.Protocol.V2, routerSdk.Protocol.V3, routerSdk.Protocol.MIXED];
  ...
  endpoints: build => ({
    getTradeQuote: build.query({
      async onQueryStarted(args, _ref) {
        ...
        if (args === react.skipToken) return;
      ...
      async queryFn(args) {
        ...
        args.amount !== null) {
          try {
            ...
            const query = qs__default["default"].stringify(_objectSpread$g(_objectSpread$g({}, DEFAULT_QUERY_PARAMS), {}, {
              tokenInAddress,
              tokenInChainId,
              tokenOutAddress,
              tokenOutChainId,
        ...
        const clientSideSmartOrderRouter = await Promise.resolve().then(function () { return require('./clientSideSmartOrderRouter-a46b6369.cjs'); });
        try {
...
function getContract(address, ABI, provider, account) {
  ...
  return new require$$3.Contract(address, ABI, getProviderOrSigner(provider, account));
}
...
function useNativeCurrencyBalances(uncheckedAddresses) {
  ...
  const validAddressInputs = React.useMemo(() => uncheckedAddresses ? uncheckedAddresses.map(isAddress).filter(a => a !== false).sort().map(addr => [addr]) : [], [uncheckedAddresses]);
  const results = useSingleContractMultipleData(multicallContract, 'getEthBalance', validAddressInputs);
  return React.useMemo(() => validAddressInputs.reduce((memo, _ref, i) => {
    var _results$i;
    let [address] = _ref;
...
const ERC20Interface = new abi$1.Interface(ERC20ABI);
...
function useCurrencyBalances(account, currencies) {
  ...
  const ethBalance = useNativeCurrencyBalances(React.useMemo(() => containsETH ? [account] : [], [containsETH, account]));
  return React.useMemo(() => {
    var _currencies$map;
...
function useOnSupportedNetwork(chainId) {
  ...
  return React.useMemo(() => Boolean(chainId && ALL_SUPPORTED_CHAIN_IDS.includes(chainId)), [chainId]);
}
...
var e,
  ...
  t = require$$1__default["default"],
  r = require$$2__default["default"],
  a = require$$3__default["default"],
...
var invariant = _interopDefault$1(invariant$1);
var hash = require$$1__default["default"];
var bignumber = require$$2__default["default"];
var contracts = require$$3__default["default"];
...
const transactionsAtom = immer.atomWithImmer({});
...
class CancelledError extends Error {
  constructor() {
    super('Cancelled');
    _defineProperty__default["default"](this, "isCancelledError", true);
  }
}
...
class RetryableError extends Error {
  constructor() {
    super(...arguments);
    _defineProperty__default["default"](this, "isRetryableError", true);
  }
}
/**
...
function usePendingTransactions() {
  ...
  const txs = utils.useAtomValue(transactionsAtom);
...
function useAddTransactionInfo() {
  ...
  const updateTxs = utils.useUpdateAtom(transactionsAtom);
...
function TransactionsUpdater(_ref2) {
  ...
  const updateTxs = utils.useUpdateAtom(transactionsAtom);
  const onCheck = React.useCallback(_ref3 => {
    let {
      chainId,
      hash,
      blockNumber
  ...
  const onReceipt = React.useCallback(_ref4 => {
    let {
      chainId,
      hash,
      receipt
  ...
  const oldPendingTxs = React.useRef({});
  React.useEffect(() => {
...
function usePerfEventHandler(name, args, callback) {
  const perfHandler = utils.useAtomValue(swapEventHandlersAtom)[name];
...
function usePermitAllowance(token, owner, spender) {
  ...
  const inputs = React.useMemo(() => [owner, token === null || token === void 0 ? void 0 : token.address, spender], [owner, spender, token === null || token === void 0 ? void 0 : token.address]);

  // If there is no allowance yet, re-check next observed block.
  // This guarantees that the permitAllowance is synced upon submission and updated upon being synced.
  const [blocksPerFetch, setBlocksPerFetch] = React.useState();
  ...
  const allowance = React.useMemo(() => token && rawAmount ? sdkCore.CurrencyAmount.fromRawAmount(token, rawAmount) : undefined, [token, rawAmount]);
  React.useEffect(() => setBlocksPerFetch(allowance !== null && allowance !== void 0 && allowance.equalTo(0) ? 1 : undefined), [allowance]);
  return React.useMemo(() => ({
...
function useUpdatePermitAllowance(token, spender, nonce, onPermitSignature) {
  ...
  const updatePermitAllowance = React.useCallback(() => WidgetPromise.from(async () => {
    ...
    const signature = await signing.signTypedData(provider.getSigner(account), domain, types, values);
  ...
  const args = React.useMemo(() => token && spender ? {
    token,
    spender
...
function useUpdateTokenAllowance(amount, spender) {
  ...
  const updateTokenAllowance = React.useCallback(() => WidgetPromise.from(async () => {
    if (!amount) throw new Error('missing amount');
    if (!contract) throw new Error('missing contract');
    if (!spender) throw new Error('missing spender');
    let allowance = sdkCore.MaxUint256.toString();
  ...
  const args = React.useMemo(() => amount && spender ? {
...
function usePermit2Allowance(amount, spender) {
  ...
  const [approvalState, setApprovalState] = React.useState(ApprovalState$1.SYNCED);
  ...
  const approveAndPermit = React.useCallback(async () => {
...
const ONE_HUNDRED_PERCENT = new sdkCore.Percent('1');
...
function pickAtom(anAtom, key) {
  ...
  return jotai.atom(get => get(anAtom)[key], (get, set, update) => set(immer.withImmer(anAtom), value => {
...
const controlledAtom = jotai.atom(undefined);
const stateAtom = utils.atomWithReset(initialSettings);
...
function useUSDCPrice(currency) {
  ...
  const [routerPreference] = jotai.useAtom(routerPreferenceAtom);
  const trade = useRouterTrade(sdkCore.TradeType.EXACT_OUTPUT, amountOut, currency, stablecoin, {
  ...
  const lastPrice = React.useRef(price);
...
function useAutoSlippageTolerance() {
  return React.useMemo(() => DEFAULT_AUTO_SLIPPAGE, []);
}
...
function useSlippage(trade) {
  const slippage = utils.useAtomValue(slippageAtom);
  const autoSlippage = useAutoSlippageTolerance(slippage.auto ? trade : undefined);
  const maxSlippage = React.useMemo(() => toPercent(slippage.max), [slippage.max]);
  return React.useMemo(() => {
...
const MAX_VALID_SLIPPAGE = new sdkCore.Percent(1, 2);
const MIN_HIGH_SLIPPAGE = new sdkCore.Percent(1, 100);
...
function useInitialFlags(_ref) {
  ...
  return React.useMemo(() => [[flagsAtom, {
    brandedFooter,
    permit2
  }]], []);
}
...
function usePermit2() {
  ...
  return (_useAtomValue$permit = utils.useAtomValue(flagsAtom).permit2) !== null && _useAtomValue$permit !== void 0 ? _useAtomValue$permit : false;
}
  ...
  return React.useMemo(() => {
    ...
    return {
      ...
      sign: async () => {
        ...
        return provider.send('eth_signTypedData_v4', [account, data]).then(bytes.splitSignature).then(signature => {
...
function useCurrentBlockTimestamp() {
  ...
  return React.useMemo(() => typeof resultStr === 'string' ? require$$2.BigNumber.from(resultStr) : undefined, [resultStr]);
}
...
function useTransactionTtl() {
  ...
  const [ttl, setTtlBase] = jotai.useAtom(transactionTtlAtom);
  const setTtl = React.useCallback(ttl => {
...
function useSwapApproval(amount) {
  ...
  const approveOrSign = React.useMemo(() => {
...
function useWrapCallback() {
  ...
  const parsedAmountIn = React.useMemo(() => tryParseCurrencyAmount(amount, inputCurrency !== null && inputCurrency !== void 0 ? inputCurrency : undefined), [inputCurrency, amount]);
  const wrapCallback = React.useCallback(() => WidgetPromise.from(async () => {
  ...
  const args = React.useMemo(() => parsedAmountIn && {
    amount: parsedAmountIn
  }, [parsedAmountIn]);
...
function useComputeSwapInfo() {
  ...
  const parsedAmount = React.useMemo(() => tryParseCurrencyAmount(amount, isExactInput(type) ? currencyIn : currencyOut), [amount, currencyIn, currencyOut, type]);
  const [routerPreference] = jotai.useAtom(routerPreferenceAtom);
  ...
  const [amountIn, amountOut] = React.useMemo(() => {
  ...
  const currencies = React.useMemo(() => [currencyIn, currencyOut], [currencyIn, currencyOut]);
  ...
  const maximumAmountIn = React.useMemo(() => {
    var _trade$trade5;
...
const SwapInfoContext = /*#__PURE__*/React.createContext(DEFAULT_SWAP_INFO);
function SwapInfoProvider(_ref) {
  let {
    children
  } = _ref;
  const swapInfo = useComputeSwapInfo();
  const swap = utils.useAtomValue(swapAtom);
  const lastQuotedSwap = React.useRef(null);
  const {
    onInitialSwapQuote
  } = utils.useAtomValue(swapEventHandlersAtom);
  React.useEffect(() => {
...
function useSyncController(_ref) {
  ...
  const isSwapControlled = React.useRef(Boolean(value));
  const isSettingsControlled = React.useRef(Boolean(settings));
  React.useEffect(() => {
  ...
  const [controlledSwap, setControlledSwap] = jotai.useAtom(controlledAtom$1);
  if (controlledSwap !== value) {
    setControlledSwap(value);
  }
  const [controlledSettings, setControlledSettings] = jotai.useAtom(controlledAtom);
...
function useSyncConvenienceFee(_ref) {
  ...
  const updateFeeOptions = utils.useUpdateAtom(feeOptionsAtom);
  React.useEffect(() => {
...
function useSyncSwapEventHandlers(handlers) {
  const setSwapEventHandlersAtom = utils.useUpdateAtom(swapEventHandlersAtom);
  React.useEffect(() => setSwapEventHandlersAtom(handlers), [handlers, setSwapEventHandlersAtom]);
}

function useSyncSwapRouterUrl(routerUrl) {
  const setSwapRouterUrlAtom = utils.useUpdateAtom(swapRouterUrlAtom);
  React.useEffect(() => setSwapRouterUrlAtom(routerUrl), [routerUrl, setSwapRouterUrlAtom]);
}
...
function useNativeCurrency() {
  ...
  return React.useMemo(() => chainId ? nativeOnChain(chainId) :
...
function useHasFocus(node) {
  ...
  const [hasFocus, setHasFocus] = React.useState((_node$contains = node === null || node === void 0 ? void 0 : node.contains((_document = document) === null || _document === void 0 ? void 0 : _document.activeElement)) !== null && _node$contains !== void 0 ? _node$contains : false);
...
function useHasHover(node) {
  ...
  const onMouseEnter = React.useCallback(() => setHasHover(true), []);
  const onMouseLeave = React.useCallback(() => setHasHover(false), []);
  React.useEffect(() => {
...
const globalFontStyles = styled.css(_templateObject$K || (_templateObject$K = _taggedTemplateLiteral__default["default"](["\n  -moz-osx-font-smoothing: grayscale;\n  -webkit-font-smoothing: antialiased;\n  color: ", ";\n  font-size: 16px;\n  font-smooth: always;\n  font-variant: none;\n\n  * {\n    font-family: ", ";\n\n    @supports (font-variation-settings: normal) {\n      font-family: ", ";\n    }\n  }\n"])), _ref => {
  let {
    theme
  } = _ref;
...
const BoundaryContext = /*#__PURE__*/React.createContext(null);
...
const PopoverContainer = styled__default["default"].div(_templateObject$J || (_templateObject$J = _taggedTemplateLiteral__default["default"](["\n  ", "\n  background-color: ", ";\n  border: 1px solid ", ";\n  border-radius: 0.5rem;\n  opacity: ", ";\n  padding: 0.75rem;\n  transition: visibility ", " linear, opacity ", " linear;\n  visibility: ", ";\n  z-index: ", ";\n"])), globalFontStyles, _ref2 => {
  let {
    theme
  } = _ref2;
  return theme.dialog;
...
const Reference = styled__default["default"].div(_templateObject2$v || (_templateObject2$v = _taggedTemplateLiteral__default["default"](["\n  align-items: center;\n  display: flex;\n  justify-content: center;\n  min-height: 1rem;\n"])));
const Arrow = styled__default["default"].div(_templateObject3$k || (_templateObject3$k = _taggedTemplateLiteral__default["default"](["\n  height: 8px;\n  width: 8px;\n  z-index: ", ";\n\n  ::before {\n    background: ", ";\n    border: 1px solid ", ";\n    content: '';\n    height: 8px;\n    position: absolute;\n    transform: rotate(45deg);\n    width: 8px;\n  }\n\n  &.arrow-top {\n    bottom: -4px;\n    ::before {\n      border-radius: 1px;\n      border-left: none;\n      border-top: none;\n    }\n  }\n\n  &.arrow-bottom {\n    top: -5px; // includes -1px from border\n    ::before {\n      border-bottom: none;\n      border-right: none;\n      border-radius: 1px;\n    }\n  }\n\n  &.arrow-left {\n    right: -4px;\n    ::before {\n      border-bottom: none;\n      border-left: none;\n      border-radius: 1px;\n    }\n  }\n\n  &.arrow-right {\n    left: -5px; // includes -1px from border\n    ::before {\n      border-radius: 1px;\n      border-right: none;\n      border-top: none;\n    }\n  }\n"])), Layer.TOOLTIP, _ref4 => {
  let {
    theme
  } = _ref4;
  return theme.dialog;
...
function Popover(_ref6) {
  ...
  const options = React.useMemo(() => {
    ...
    if (contained) {
      ...
      }, _objectSpread$c(_objectSpread$c({}, maxSize__default["default"]), {}, {
        options: {
          boundary,
          padding: 8
        }
  ...
  const {
    ...
    attributes,
    update
  } = reactPopper.usePopper(reference.current, popover === null || popover === void 0 ? void 0 : popover.current, options);
  const updateCallback = React.useCallback(() => {
    update && update();
  }, [update]);
  useInterval(updateCallback, show ? 100 : null);
  const containerOnClick = React.useCallback(e => {
    e.stopPropagation();
  }, []);
...
const SmallToolTipBody = styled__default["default"](Caption$1)(_templateObject$I || (_templateObject$I = _taggedTemplateLiteral__default["default"](["\n  max-width: 220px;\n"])));
const IconTooltip = styled__default["default"](IconButton)(_templateObject2$u || (_templateObject2$u = _taggedTemplateLiteral__default["default"](["\n  cursor: help;\n"])));
function Tooltip(_ref) {
  let {
    icon = /*#__PURE__*/React__default["default"].createElement(Info, null),
    iconProps,
    children,
    placement = 'auto',
    offset,
  ...
  return /*#__PURE__*/React__default["default"].createElement(Popover, {
    ...
    offset: offset,
    contained: contained
  }, /*#__PURE__*/React__default["default"].createElement(IconTooltip, _extends__default["default"]({
    icon: icon,
    ref: setTooltip
  }, iconProps)));
}
...
const StyledButton = styled__default["default"](Button$1)(_templateObject$H || (_templateObject$H = _taggedTemplateLiteral__default["default"](["\n  border-radius: ", "rem;\n  flex-grow: 1;\n  max-height: ", ";\n  transition: background-color ", " ease-out, border-radius ", " ease-out,\n    flex-grow ", " ease-out;\n  ", ";\n"])), _ref => {
  let {
    theme,
    narrow
  } = _ref;
  ...
  return disabled && (shouldUseDisabledColor ? styled.css(_templateObject2$t || (_templateObject2$t = _taggedTemplateLiteral__default["default"](["\n          background-color: ", ";\n        "])), theme.interactive) : styled.css(_templateObject3$j || (_templateObject3$j = _taggedTemplateLiteral__default["default"](["\n          opacity: 0.6;\n        "]))));
});
const ActionRow = styled__default["default"](Row)(_templateObject4$a || (_templateObject4$a = _taggedTemplateLiteral__default["default"]([""])));
const grow = styled.keyframes(_templateObject5$7 || (_templateObject5$7 = _taggedTemplateLiteral__default["default"](["\n  from {\n    opacity: 0;\n    width: 0;\n  }\n  to {\n    opacity: 1;\n    width: max-content;\n  }\n"])));
const actionCss = styled.css(_templateObject6$6 || (_templateObject6$6 = _taggedTemplateLiteral__default["default"](["\n  align-items: center;\n  border: 1px solid ", ";\n  padding: calc(0.25rem - 1px) calc(0.75rem - 1px);\n\n  ", " {\n    animation: ", " ", " ease-in;\n    flex-grow: 1;\n    justify-content: flex-start;\n    white-space: nowrap;\n  }\n\n  ", " {\n    /* Subtract the padding from the borderRadius so that it nests properly. */\n    border-radius: ", "rem;\n    flex-grow: 0;\n    height: 2.5rem;\n    padding: 0 0.75rem;\n  }\n"])), _ref4 => {
  let {
    theme
  } = _ref4;
  return theme.outline;
...
const Overlay = styled__default["default"](Row)(_templateObject7$6 || (_templateObject7$6 = _taggedTemplateLiteral__default["default"](["\n  border-radius: ", "rem;\n  flex-flow: row-reverse nowrap;\n  margin-top: 0.25rem;\n  min-height: ", ";\n  transition: padding ", " ease-out;\n  ", "\n"])), _ref6 => {
  let {
    theme,
    narrow
  } = _ref6;
...
function ActionButton(_ref9) {
  ...
  const buttonSize = React.useMemo(() => narrow ? 'small' : action ? 'medium' : 'large', [narrow, action]);
  return /*#__PURE__*/React__default["default"].createElement(Overlay, _extends__default["default"]({
    ...
    placement: "right",
    icon: /*#__PURE__*/React__default["default"].createElement(LargeIcon, {
      icon: reactFeather.AlertTriangle,
...
const Column = styled__default["default"].div(_templateObject$G || (_templateObject$G = _taggedTemplateLiteral__default["default"](["\n  align-items: ", ";\n  color: ", ";\n  display: ", ";\n  flex-direction: column;\n  flex-grow: ", ";\n  gap: ", ";\n  grid-auto-flow: row;\n  grid-template-columns: 1fr;\n  justify-content: ", ";\n  padding: ", ";\n\n  ", "\n"])), _ref => {
  let {
    align
  } = _ref;
  return align !== null && align !== void 0 ? align : 'center';
...
const Rule = styled__default["default"].hr(_templateObject$F || (_templateObject$F = _taggedTemplateLiteral__default["default"](["\n  border: none;\n  border-bottom: 1px solid ", ";\n  margin: 0 ", ";\n  margin-bottom: ", "px;\n  margin-top: ", "px;\n\n  // Integrators will commonly modify hr width - this overrides any modifications within the widget.\n  max-width: auto;\n  width: auto;\n"])), _ref => {
  let {
    theme
  } = _ref;
  return theme.outline;
...
const overflowCss = styled.css(_templateObject$E || (_templateObject$E = _taggedTemplateLiteral__default["default"](["\n  overflow-y: scroll;\n"])));
const hiddenScrollbarCss = styled.css(_templateObject2$s || (_templateObject2$s = _taggedTemplateLiteral__default["default"](["\n  overflow-y: auto;\n"])));

/** Customizes the scrollbar for vertical overflow. */
const scrollbarCss = padded => styled.css(_templateObject3$i || (_templateObject3$i = _taggedTemplateLiteral__default["default"](["\n  overflow-y: scroll;\n\n  ::-webkit-scrollbar {\n    width: 1.25rem;\n  }\n\n  ::-webkit-scrollbar-thumb {\n    background: radial-gradient(\n        closest-corner at 0.25rem 0.25rem,\n        ", " 0.25rem,\n        transparent 0.25rem\n      ),\n      linear-gradient(\n        to bottom,\n        #ffffff00 0.25em,\n        ", " 0.25rem,\n        ", " calc(100% - 0.25rem),\n        #ffffff00 calc(100% - 0.25rem)\n      ),\n      radial-gradient(\n        closest-corner at 0.25em calc(100% - 0.25rem),\n        ", " 0.25rem,\n        #ffffff00 0.25rem\n      );\n    background-clip: padding-box;\n    border: none;\n    ", ": 0.75rem solid transparent;\n  }\n\n  @supports not selector(::-webkit-scrollbar-thumb) {\n    scrollbar-color: ", " transparent;\n  }\n"])), _ref => {
  let {
    theme
  } = _ref;
  return theme.interactive;
...
const HeaderColumn = styled__default["default"](Column)(_templateObject$D || (_templateObject$D = _taggedTemplateLiteral__default["default"](["\n  cursor: pointer;\n  padding: 1.25rem 1.5rem;\n"])));
const StyledWrapper = styled__default["default"](Column)(_templateObject2$r || (_templateObject2$r = _taggedTemplateLiteral__default["default"](["\n  background-color: ", ";\n  border-radius: ", "rem;\n  overflow: hidden;\n\n  @supports (overflow: clip) {\n    overflow: clip;\n  }\n"])), _ref => {
  let {
    theme
  } = _ref;
  return theme.module;
...
const TitleRow = styled__default["default"](Row)(_templateObject3$h || (_templateObject3$h = _taggedTemplateLiteral__default["default"](["\n  cursor: pointer;\n"])));
const TitleHeader = styled__default["default"].div(_templateObject4$9 || (_templateObject4$9 = _taggedTemplateLiteral__default["default"](["\n  align-items: center;\n  display: flex;\n  justify-content: center;\n"])));
...
const ExpandoColumn = styled__default["default"](Column)(_templateObject5$6 || (_templateObject5$6 = _taggedTemplateLiteral__default["default"](["\n  max-height: ", "rem;\n  overflow: hidden;\n  position: relative;\n  transition: max-height ", ", padding ", ";\n"])), _ref3 => {
  let {
    open,
    height,
    maxHeight
...
const InnerColumn = styled__default["default"](Column)(_templateObject6$5 || (_templateObject6$5 = _taggedTemplateLiteral__default["default"](["\n  max-height: ", "rem;\n"])), _ref4 => {
  let {
    height,
    maxHeight
  } = _ref4;
...
const IconPrefix = styled__default["default"].div(_templateObject7$5 || (_templateObject7$5 = _taggedTemplateLiteral__default["default"](["\n  color: ", ";\n"])), _ref5 => {
  let {
    theme
  } = _ref5;
  return theme.primary;
...
function Expando(_ref6) {
  ...
  const [scrollingEl, setScrollingEl] = React.useState(null);
  ...
  return /*#__PURE__*/React__default["default"].createElement(Column, rest, styledWrapper ? /*#__PURE__*/React__default["default"].createElement(StyledWrapper, {
    ...
    height: height,
    maxHeight: maxHeight
  }, /*#__PURE__*/React__default["default"].createElement(InnerColumn, {
    flex: true,
    align: "stretch",
    height: height,
    maxHeight: maxHeight,
...
const HeaderIcon = styled__default["default"](LargeIcon)(_templateObject$C || (_templateObject$C = _taggedTemplateLiteral__default["default"](["\n  flex-grow: 1;\n  margin: 2rem 0;\n"])));
...
const ExpandoContent = styled__default["default"](Code)(_templateObject2$q || (_templateObject2$q = _taggedTemplateLiteral__default["default"](["\n  margin: 0.5rem;\n"])));
const ErrorDialogWrapper = styled__default["default"](Column)(_templateObject3$g || (_templateObject3$g = _taggedTemplateLiteral__default["default"](["\n  background-color: ", ";\n"])), _ref2 => {
  let {
    theme
  } = _ref2;
...
function useAsyncError() {
  ...
  return React.useCallback(error => setError(() => {
...
function resolverContract(resolverAddress, provider) {
  return new require$$3.Contract(resolverAddress, RESOLVER_ABI, provider);
}
...
async function resolveENSContentHash(ensName, provider) {
  const ensRegistrarContract = new require$$3.Contract(REGISTRAR_ADDRESS, REGISTRAR_ABI, provider);
  const hash = require$$1.namehash(ensName);
...
function useLogo(currency) {
  ...
  const entry = React.useMemo(() => table.getEntry(currency), [currency]);
  const [src, setSrc] = React.useState(entry === null || entry === void 0 || (_entry$getCurrent = entry.getCurrent()) === null || _entry$getCurrent === void 0 ? void 0 : _entry$getCurrent.getUri());
  React.useEffect(() => {
  ...
  const invalidateSrc = React.useCallback(() => {
...
const MissingImageLogo = styled__default["default"].div(_templateObject$B || (_templateObject$B = _taggedTemplateLiteral__default["default"](["\n  --size: ", ";\n  background-color: ", ";\n  border-radius: 100px;\n  color: ", ";\n  font-size: calc(var(--size) / 3);\n  font-weight: 500;\n  height: ", ";\n  line-height: ", ";\n  text-align: center;\n  width: ", ";\n"])), _ref => {
  let {
    size
  } = _ref;
...
const LogoImage = styled__default["default"].img(_templateObject2$p || (_templateObject2$p = _taggedTemplateLiteral__default["default"](["\n  background: radial-gradient(white 60%, #ffffff00 calc(70% + 1px));\n  border-radius: 50%;\n  box-shadow: 0 0 1px white;\n  height: ", ";\n  width: ", ";\n"])), _ref7 => {
  let {
    size
  } = _ref7;
  return size;
    ...
    case 'ipns-ns':
      {
        ...
        if (multihash.name === 'identity') {
          ...
          return "ipns://".concat(multihashes.toB58String(cid.multihash));
        }
      }
    default:
...
async function validate(schema, data) {
  ...
  switch (schema) {
    case ValidationSchema.LIST:
      validatorImport = Promise.resolve().then(function () { return require('./validateTokenList-9fe5385c.cjs'); });
      break;
    case ValidationSchema.TOKENS:
      validatorImport = Promise.resolve().then(function () { return require('./validateTokens-b9723760.cjs'); });
      break;
    default:
      throw new Error('No validation function specified for schema');
  }
  const [, validatorModule] = await Promise.all([Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require('ajv')); }), validatorImport]);
...
function useQueryTokens(query, tokens) {
  ...
  const filter = React.useMemo(() => getTokenFilter(debouncedQuery), [debouncedQuery]);
  const filteredTokens = React.useMemo(() => sortedTokens.filter(filter), [filter, sortedTokens]);
  const queriedTokens = useSortTokensByQuery(debouncedQuery, filteredTokens);
  const native = React.useMemo(() => chainId && nativeOnChain(chainId), [chainId]);
  return React.useMemo(() => {
...
const ChainTokenMapContext = /*#__PURE__*/React.createContext(MISSING_PROVIDER);
function useChainTokenMapContext() {
  const chainTokenMap = React.useContext(ChainTokenMapContext);
...
function Provider$6(_ref4) {
  ...
  const [chainTokenMap, setChainTokenMap] = React.useState();
  React.useEffect(() => setChainTokenMap(undefined), [list]);
  const {
    chainId,
    provider
  } = core.useWeb3React();
  const resolver = React.useCallback(ensName => {
...
function useTokenFromNetwork(tokenAddress) {
  ...
  const tokenName = useSingleCallResult(tokenContract, 'name', undefined, reduxMulticall.NEVER_RELOAD);
  const tokenNameBytes32 = useSingleCallResult(tokenContractBytes32, 'name', undefined, reduxMulticall.NEVER_RELOAD);
  const symbol = useSingleCallResult(tokenContract, 'symbol', undefined, reduxMulticall.NEVER_RELOAD);
  const symbolBytes32 = useSingleCallResult(tokenContractBytes32, 'symbol', undefined, reduxMulticall.NEVER_RELOAD);
  const decimals = useSingleCallResult(tokenContract, 'decimals', undefined, reduxMulticall.NEVER_RELOAD);
  return React.useMemo(() => {
...
function useSyncTokenDefaults(_ref) {
  ...
  const lastChainId = React.useRef(undefined);
  const lastConnector = React.useRef(undefined);
  const updateSwap = utils.useUpdateAtom(swapAtom);
  const {
    chainId,
    connector
  } = core.useWeb3React();
  ...
  const setToDefaults = React.useCallback(shouldUseDefaultChainId => {
...
const OnCloseContext = /*#__PURE__*/React.createContext(undefined);
...
const HeaderRow$2 = styled__default["default"](Row)(_templateObject$A || (_templateObject$A = _taggedTemplateLiteral__default["default"](["\n  display: flex;\n  height: 1.75rem;\n  justify-content: flex-start;\n  margin: 0.5rem 0.75rem 0.75rem;\n  position: relative;\n"])));
const StyledBackButton = styled__default["default"](ArrowLeft)(_templateObject2$o || (_templateObject2$o = _taggedTemplateLiteral__default["default"](["\n  :hover {\n    cursor: pointer;\n    opacity: 0.6;\n  }\n"])));
const Title = styled__default["default"].div(_templateObject3$f || (_templateObject3$f = _taggedTemplateLiteral__default["default"](["\n  display: flex;\n  flex-grow: 1;\n  justify-content: center;\n"])));
function Header$1(_ref2) {
  ...
  return /*#__PURE__*/React__default["default"].createElement(HeaderRow$2, {
    ...
    onClick: onClose
  }), /*#__PURE__*/React__default["default"].createElement(Title, null, /*#__PURE__*/React__default["default"].createElement(Subhead1, null, title)), !closeButton && animationType !== DialogAnimationType.SLIDE && /*#__PURE__*/React__default["default"].createElement(StyledXButton, {
    onClick: onClose
  }));
}
const Modal = styled__default["default"].div(_templateObject4$8 || (_templateObject4$8 = _taggedTemplateLiteral__default["default"](["\n  ", ";\n\n  background-color: ", ";\n  border-radius: ", "rem;\n  display: flex;\n  flex-direction: column;\n  height: ", ";\n  left: 0;\n  outline: ", ";\n  padding: ", ";\n  position: ", ";\n  right: 0;\n  top: 0;\n  z-index: ", ";\n"])), globalFontStyles, _ref3 => {
  let {
    color,
    theme
  } = _ref3;
...
const slideInLeft = styled.keyframes(_templateObject5$5 || (_templateObject5$5 = _taggedTemplateLiteral__default["default"](["\n  from {\n    transform: translateX(calc(100% - 0.25rem));\n  }\n"])));
const slideOutLeft = styled.keyframes(_templateObject6$4 || (_templateObject6$4 = _taggedTemplateLiteral__default["default"](["\n  to {\n    transform: translateX(calc(0.25rem - 100%));\n  }\n"])));
const slideOutRight = styled.keyframes(_templateObject7$4 || (_templateObject7$4 = _taggedTemplateLiteral__default["default"](["\n  to {\n    transform: translateX(calc(100% - 0.25rem));\n  }\n"])));
const HiddenWrapper = styled__default["default"].div(_templateObject8$1 || (_templateObject8$1 = _taggedTemplateLiteral__default["default"](["\n  border-radius: ", "rem;\n  height: ", ";\n  left: 0;\n  outline: transparent;\n  overflow: ", ";\n  position: ", ";\n  top: 0;\n\n  width: ", ";\n  @supports (overflow: clip) {\n    overflow: ", ";\n  }\n"])), _ref9 => {
  let {
    theme
  } = _ref9;
  return theme.borderRadius.large;
...
const slideAnimationCss = styled.css(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral__default["default"](["\n  animation: ", " ", " ease-in;\n\n  &.", " {\n    animation: ", " ", " ease-in;\n  }\n  &.", " {\n    animation: ", " ", " ease-out;\n  }\n"])), slideInLeft, AnimationSpeed.Medium, SlideAnimationType.PAGING, slideOutLeft, AnimationSpeed.Medium, SlideAnimationType.CLOSING, slideOutRight, AnimationSpeed.Medium);
const EMPTY_CSS = styled.css(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral__default["default"]([""])));
...
const FullScreenWrapper = styled__default["default"].div(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral__default["default"](["\n  ", "\n"])), _ref13 => {
  let {
    enabled,
    fadeAnimation
  } = _ref13;
  return enabled && styled.css(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral__default["default"](["\n      align-items: center;\n      ", "\n      background-color: ", ";\n      display: flex;\n      height: 100%;\n      justify-content: center;\n      left: 0;\n      position: fixed;\n      top: 0;\n      width: 100%;\n\n      z-index: ", ";\n\n      ", " {\n        box-shadow: 0px 40px 120px ", ";\n        min-width: 400px;\n      }\n    "])), fadeAnimation ? fadeAnimationCss : '', _ref14 => {
    let {
      theme
    } = _ref14;
    return theme.scrim;
...
const AnimationWrapper = styled__default["default"].div(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral__default["default"](["\n  ", " {\n    ", "\n  }\n"])), Modal, _ref16 => {
  let {
    animationType
  } = _ref16;
...
function Dialog(_ref17) {
  ...
  const [updatePopover, setUpdatePopover] = React.useState(false);
  React.useEffect(() => {
  ...
  const closeOnBackgroundClick = React.useCallback(() => {
...
const HeaderRow$1 = styled__default["default"](Row)(_templateObject$z || (_templateObject$z = _taggedTemplateLiteral__default["default"](["\n  height: 1.5rem;\n  margin: 0.5rem 0.75rem 1rem;\n  svg {\n    align-self: center;\n    height: 1.2em;\n    width: 1.2em;\n  }\n"])));
...
const loadingCss = styled.css(_templateObject$y || (_templateObject$y = _taggedTemplateLiteral__default["default"](["\n  filter: grayscale(1);\n  opacity: ", ";\n"])), loadingOpacity);

// need to use isLoading as `loading` is a reserved prop
const loadingTransitionCss = styled.css(_templateObject2$n || (_templateObject2$n = _taggedTemplateLiteral__default["default"](["\n  opacity: ", ";\n  transition: color ", " linear,\n    opacity ", " ease-in-out;\n"])), _ref => {
  let {
    isLoading
  } = _ref;
...
function useSwitchSwapCurrencies() {
  ...
  const setSwap = utils.useUpdateAtom(swapAtom);
  return React.useCallback(() => {
    setSwap(swap => {
...
function useSwapCurrency(field) {
  const currencyAtom = React.useMemo(() => pickAtom(swapAtom, field), [field]);
  const [currency, setCurrency] = jotai.useAtom(currencyAtom);
  const otherCurrencyAtom = React.useMemo(() => pickAtom(swapAtom, otherField(field)), [field]);
  const otherCurrency = utils.useAtomValue(otherCurrencyAtom);
  const {
    onTokenChange
  } = utils.useAtomValue(swapEventHandlersAtom);
  const switchSwapCurrencies = useSwitchSwapCurrencies();
  const setOrSwitchCurrency = React.useCallback(update => {
...
function useIsSwapFieldIndependent(field) {
  const type = utils.useAtomValue(tradeTypeAtom);
...
function useSwapAmount(field) {
  const value = utils.useAtomValue(amountAtom);
  ...
  const setSwap = utils.useUpdateAtom(swapAtom);
  const updateAmount = React.useCallback((update, origin) => {
...
async function getColorFromUriPath(uri) {
  try {
    ...
    const palette = await Vibrant__default["default"].from(uri).getPalette();
...
const WidgetWidthContext = /*#__PURE__*/React.createContext(0);
...
function PriceImpactRow(_ref) {
  ...
  }, tooltipText)), (impact === null || impact === void 0 ? void 0 : impact.warning) && /*#__PURE__*/React__default["default"].createElement(Tooltip, {
    icon: /*#__PURE__*/React__default["default"].createElement(LargeIcon, {
      icon: reactFeather.AlertTriangle,
...
const Input$3 = styled__default["default"].input(_templateObject$x || (_templateObject$x = _taggedTemplateLiteral__default["default"](["\n  -webkit-appearance: textfield;\n  background-color: transparent;\n  border: none;\n  color: currentColor;\n  font-family: inherit;\n  font-size: inherit;\n  font-weight: inherit;\n  line-height: inherit;\n  margin: 0;\n  outline: none;\n  overflow: hidden;\n  padding: 0;\n  text-align: left;\n  text-overflow: ellipsis;\n  width: 100%;\n\n  ::-webkit-search-decoration {\n    -webkit-appearance: none;\n  }\n\n  [type='number'] {\n    -moz-appearance: textfield;\n  }\n\n  ::-webkit-outer-spin-button,\n  ::-webkit-inner-spin-button {\n    -webkit-appearance: none;\n  }\n\n  ::placeholder {\n    color: ", ";\n  }\n\n  :enabled {\n    transition: color ", " linear;\n  }\n"])), _ref => {
  let {
    theme
  } = _ref;
  return theme.hint;
}, AnimationSpeed.Fast);
const StringInput = /*#__PURE__*/React.forwardRef(function StringInput(_ref2, ref) {
  let {
      value,
      onChange
    } = _ref2,
...
const NumericInput = /*#__PURE__*/React.forwardRef(function NumericInput(_ref3, ref) {
  let {
      value,
      onChange,
      enforcer,
  ...
  const validateChange = React.useCallback(event => {
    var _enforcer;
...
const IntegerInput = /*#__PURE__*/React.forwardRef(function IntegerInput(props, ref) {
...
const DecimalInput = /*#__PURE__*/React.forwardRef(function DecimalInput(props, ref) {
  return /*#__PURE__*/React__default["default"].createElement(NumericInput, _extends__default["default"]({
    pattern: "^[0-9]*[.,]?[0-9]*$",
...
const inputCss = styled.css(_templateObject2$m || (_templateObject2$m = _taggedTemplateLiteral__default["default"](["\n  background-color: ", ";\n  border: 1px solid ", ";\n  border-radius: ", "rem;\n  cursor: text;\n  padding: calc(0.75rem - 1px);\n\n  :hover:not(:focus-within) {\n    background-color: ", ";\n    border-color: ", ";\n  }\n\n  :focus-within {\n    border-color: ", ";\n  }\n"])), _ref4 => {
  let {
    theme
  } = _ref4;
  return theme.module;
...
const slideInBottom = styled.keyframes(_templateObject$w || (_templateObject$w = _taggedTemplateLiteral__default["default"](["\n  from {\n    transform: translateY(calc(100vh));\n  }\n"])));
const slideOutBottom = styled.keyframes(_templateObject2$l || (_templateObject2$l = _taggedTemplateLiteral__default["default"](["\n  to {\n    transform: translateY(100%);\n  }\n"])));
const BottomSheetModalBackdrop = styled__default["default"].div(_templateObject3$e || (_templateObject3$e = _taggedTemplateLiteral__default["default"](["\n  background-color: ", ";\n  bottom: 0;\n  left: 0;\n  opacity: 1;\n  position: fixed;\n  right: 0;\n\n  &.hidden {\n    opacity: 0;\n    transition: visibility 0s linear ", ", opacity ", ";\n    visibility: hidden;\n  }\n\n  top: 0;\n  transition: visibility 0s linear 0s, opacity ", ";\n  visibility: visible;\n  z-index: ", ";\n"])), _ref => {
  let {
    theme
  } = _ref;
  return theme.scrim;
...
const Wrapper = styled__default["default"].div(_templateObject4$7 || (_templateObject4$7 = _taggedTemplateLiteral__default["default"](["\n  border-radius: 0;\n  bottom: 0;\n  left: 0;\n  margin: 0;\n  overflow: hidden;\n  position: absolute;\n  right: 0;\n  z-index: ", ";\n\n  @supports (overflow: clip) {\n    overflow: clip;\n  }\n\n  ", " {\n    animation: ", " ", " ease-in;\n    border-bottom-left-radius: 0;\n\n    &.", " {\n      animation: ", " ", " ease-out;\n    }\n\n    border-bottom-right-radius: 0;\n    bottom: 0;\n    box-shadow: ", ";\n    height: unset;\n    position: fixed;\n    top: unset;\n\n    * {\n      box-sizing: border-box;\n    }\n  }\n"])), _ref3 => {
  let {
    theme
  } = _ref3;
...
function BottomSheetModal(_ref5) {
  ...
  return /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement(RootElement, {
    ...
    closeButton: /*#__PURE__*/React__default["default"].createElement(StyledXButton, null)
  }), children))));
}
const RootElement = /*#__PURE__*/React.forwardRef(function RootWrapper(_ref6, ref) {
  let {
    children,
    open,
    onClose
...
var TokenImg$1 = styled__default["default"](TokenImg)(_templateObject$v || (_templateObject$v = _taggedTemplateLiteral__default["default"](["\n  // radial-gradient calculates distance from the corner, not the edge: divide by sqrt(2)\n  background: radial-gradient(\n    ", " calc(100% / ", " - 1.5px),\n    ", " calc(100% / ", " - 1.5px)\n  );\n  border-radius: 100%;\n  height: ", "rem;\n  width: ", "rem;\n"])), _ref2 => {
  let {
    theme
  } = _ref2;
  return theme.module;
...
const BasesContainer = styled__default["default"](Row)(_templateObject$u || (_templateObject$u = _taggedTemplateLiteral__default["default"](["\n  margin: 0 1.25rem;\n"])));
const activeCss = styled.css(_templateObject2$k || (_templateObject2$k = _taggedTemplateLiteral__default["default"](["\n  background-color: ", ";\n  border-color: ", ";\n  color: ", ";\n"])), _ref => {
  let {
    theme
  } = _ref;
...
const BaseWrapper = styled__default["default"](Row)(_templateObject3$d || (_templateObject3$d = _taggedTemplateLiteral__default["default"](["\n  border: 1px solid ", ";\n  border-radius: 1rem;\n  color: ", ";\n  cursor: pointer;\n  padding: 0.5rem 0.75rem 0.5rem 0.5rem;\n\n  ", ";\n\n  :hover,\n  :focus {\n    ", "\n  }\n"])), _ref4 => {
  let {
    theme
  } = _ref4;
  return theme.outline;
...
const HelpCircleIcon = styled__default["default"](HelpCircle)(_templateObject$t || (_templateObject$t = _taggedTemplateLiteral__default["default"](["\n  height: 4rem;\n  margin-bottom: 0.75rem;\n  stroke: ", ";\n  width: 4rem;\n"])), _ref => {
  let {
    theme
  } = _ref;
  return theme.secondary;
});
const StyledColumn = styled__default["default"](Column)(_templateObject2$j || (_templateObject2$j = _taggedTemplateLiteral__default["default"](["\n  display: flex;\n  height: 80%;\n  text-align: center;\n  width: 100%;\n"])));
...
const StyledTokenButton = styled__default["default"](Button$1)(_templateObject$s || (_templateObject$s = _taggedTemplateLiteral__default["default"](["\n  border-radius: ", "rem;\n  min-height: 2rem;\n  padding: 0.25rem 0.5rem 0.25rem 0.25rem;\n\n  :enabled {\n    transition: none;\n  }\n\n  ", " {\n    filter: ", ";\n  }\n"])), _ref => {
  let {
    theme
  } = _ref;
  return theme.borderRadius.medium;
...
const TokenButtonRow = styled__default["default"](Row)(_templateObject2$i || (_templateObject2$i = _taggedTemplateLiteral__default["default"](["\n  max-width: 12rem;\n  overflow: hidden;\n  padding-left: ", "rem;\n  width: max-content;\n\n  img {\n    min-width: 1.2rem;\n  }\n"])), _ref3 => {
  let {
    empty
  } = _ref3;
  return empty && 0.5;
...
const TokenButton = styled__default["default"](BaseButton)(_templateObject$r || (_templateObject$r = _taggedTemplateLiteral__default["default"](["\n  border-radius: 0;\n  outline: none;\n  padding: 0.5rem 1.25rem;\n"])));
const ITEM_SIZE = 56;
const MIN_VISIBLE_TOKENS = 6;
const TokenListWrapper = styled__default["default"].div(_templateObject2$h || (_templateObject2$h = _taggedTemplateLiteral__default["default"](["\n  ", "[data-index='", "'] {\n    background-color: ", ";\n  }\n\n  ", "\n  overscroll-behavior: none;\n"])), TokenButton, _ref => {
  let {
    hover
  } = _ref;
  return hover;
...
const OnHover = styled__default["default"].div(_templateObject3$c || (_templateObject3$c = _taggedTemplateLiteral__default["default"](["\n  background-color: ", ";\n  height: ", "px;\n  left: 0;\n  position: absolute;\n  top: ", "px;\n  width: 100%;\n"])), _ref4 => {
  let {
    theme
  } = _ref4;
  return theme.onHover(theme.module);
...
const TokenBalance = styled__default["default"].div(_templateObject4$6 || (_templateObject4$6 = _taggedTemplateLiteral__default["default"](["\n  background-color: ", ";\n  border-radius: 0.25rem;\n  padding: 0.375rem 0;\n"])), _ref6 => {
  let {
    theme,
    isLoading
  } = _ref6;
...
const ItemRow = /*#__PURE__*/React.memo(function ItemRow(_ref8) {
  let {
    data: tokens,
    index,
    style
...
const TokenOptions = /*#__PURE__*/React.forwardRef(function TokenOptions(_ref9, ref) {
  let {
    tokens,
    onSelect
  } = _ref9;
  ...
  const hover = React.useMemo(() => tokens.indexOf(selected), [selected, tokens]);
  ...
  const scrollTo = React.useCallback(function (index) {
  ...
  const onClick = React.useCallback(_ref0 => {
    let {
      token
    } = _ref0;
    return token && onSelect(token);
  }, [onSelect]);
  const onFocus = React.useCallback(_ref1 => {
    let {
      index
    } = _ref1;
    setFocused(true);
  ...
  const onMouseMove = React.useCallback(_ref10 => {
    let {
      index
    } = _ref10;
  ...
  const onHover = React.useRef(null);
  // use native onscroll handler to capture Safari's bouncy overscroll effect
  useNativeEvent(element, 'scroll', React.useCallback(() => {
  ...
  return /*#__PURE__*/React__default["default"].createElement(Column, {
    ...
    return /*#__PURE__*/React__default["default"].createElement(TokenListWrapper, {
      hover: hover,
      scrollbar: scrollbar
    }, /*#__PURE__*/React__default["default"].createElement(reactWindow.FixedSizeList, {
      height,
      width: '100%',
...
const Img = styled__default["default"].div(_templateObject$q || (_templateObject$q = _taggedTemplateLiteral__default["default"](["\n  clip-path: circle(50%);\n  height: 1.5rem;\n  width: 1.5rem;\n"])));
const Symbol$1 = styled__default["default"].div(_templateObject2$g || (_templateObject2$g = _taggedTemplateLiteral__default["default"](["\n  height: 0.75rem;\n  width: 7rem;\n"])));
const Name = styled__default["default"].div(_templateObject3$b || (_templateObject3$b = _taggedTemplateLiteral__default["default"](["\n  height: 0.5rem;\n  width: 5.5rem;\n"])));
const Balance$1 = styled__default["default"].div(_templateObject4$5 || (_templateObject4$5 = _taggedTemplateLiteral__default["default"](["\n  padding: 0.375rem 0;\n  width: 1.5rem;\n"])));
const TokenRow = styled__default["default"].div(_templateObject5$4 || (_templateObject5$4 = _taggedTemplateLiteral__default["default"](["\n  outline: none;\n  padding: 0.6875rem 0.75rem;\n\n  ", ", ", ", ", ", ", " {\n    background-color: ", ";\n    border-radius: 0.25rem;\n  }\n"])), Img, Symbol$1, Name, Balance$1, _ref => {
  let {
    theme
  } = _ref;
  return theme.secondary;
...
function TokenOption() {
  ...
  }, /*#__PURE__*/React__default["default"].createElement(Symbol$1, null)), /*#__PURE__*/React__default["default"].createElement(Caption$1, {
    style: {
      display: 'flex'
    }
...
const SearchInputContainer = styled__default["default"](Row)(_templateObject$p || (_templateObject$p = _taggedTemplateLiteral__default["default"](["\n  ", "\n"])), inputCss);
const TokenSelectContainer = styled__default["default"].div(_templateObject2$f || (_templateObject2$f = _taggedTemplateLiteral__default["default"](["\n  border-radius: ", "rem;\n  min-height: ", ";\n  min-width: ", ";\n  overflow: hidden;\n  padding: 0.5rem 0 0;\n  @supports (overflow: clip) {\n    overflow: 'clip';\n  }\n"])), _ref => {
  let {
    theme
  } = _ref;
  return theme.borderRadius.medium;
...
function usePrefetchBalances() {
  ...
  const prefetchedTokenList = React.useRef();
...
function useAreBalancesLoaded() {
  ...
  const currencies = React.useMemo(() => [native, ...tokens], [native, tokens]);
...
function TokenSelectDialogContent(_ref3) {
  ...
  const [isLoaded, setIsLoaded] = React.useState(isTokenListLoaded && areBalancesLoaded);
  ...
  React.useEffect(() => setIsLoaded(Boolean(query) || isTokenListLoaded && areBalancesLoaded), [query, areBalancesLoaded, isTokenListLoaded]);
  ...
  const listHasTokens = React.useMemo(() => list.some(token => token.chainId === chainId), [chainId, list]);
...
var TokenSelect = /*#__PURE__*/React.memo(function TokenSelect(_ref4) {
  ...
  usePrefetchBalances();
  const [open, setOpen] = React.useState(false);
  const onTokenSelectorClick = useConditionalHandler(utils.useAtomValue(swapEventHandlersAtom).onTokenSelectorClick);
  const onOpen = React.useCallback(async () => {
    setOpen(await onTokenSelectorClick(field));
  }, [field, onTokenSelectorClick]);
  const selectAndClose = React.useCallback(value => {
    onSelect(value);
    setOpen(false);
  }, [onSelect, setOpen]);
...
const TokenInputRow = styled__default["default"](Row)(_templateObject$o || (_templateObject$o = _taggedTemplateLiteral__default["default"](["\n  grid-template-columns: 1fr;\n"])));
const ValueInput = styled__default["default"](DecimalInput)(_templateObject2$e || (_templateObject2$e = _taggedTemplateLiteral__default["default"](["\n  color: ", ";\n  ", ";\n"])), _ref => {
  let {
    theme
  } = _ref;
  return theme.primary;
}, loadingTransitionCss);
const TokenInputColumn = styled__default["default"](Column)(_templateObject3$a || (_templateObject3$a = _taggedTemplateLiteral__default["default"](["\n  margin: 0.25rem 1rem 0;\n"])));
const TokenInput = /*#__PURE__*/React.forwardRef(function TokenInput(_ref2, ref) {
  let {
      field,
      amount,
      currency,
...
const USDC = styled__default["default"](Row)(_templateObject$n || (_templateObject$n = _taggedTemplateLiteral__default["default"](["\n  ", ";\n  gap: 0.25rem;\n"])), loadingTransitionCss);
const Balance = styled__default["default"](Body2)(_templateObject2$d || (_templateObject2$d = _taggedTemplateLiteral__default["default"](["\n  transition: color ", " ease-in-out;\n"])), AnimationSpeed.Medium);
const InputColumn$1 = styled__default["default"](Column)(_templateObject3$9 || (_templateObject3$9 = _taggedTemplateLiteral__default["default"](["\n  background-color: ", ";\n  border-radius: ", "rem;\n  margin-bottom: 0.25rem;\n  padding: ", ";\n  position: relative;\n\n  &:before {\n    background-size: 100%;\n    border: 1px solid transparent;\n    border-radius: inherit;\n    box-sizing: border-box;\n    content: '';\n    height: 100%;\n    left: 0;\n    pointer-events: none;\n    position: absolute;\n    top: 0;\n    transition: 125ms ease border-color;\n    width: 100%;\n  }\n\n  ", "\n"])), _ref => {
  let {
    theme
  } = _ref;
  return theme.module;
...
function FieldWrapper(_ref6) {
  ...
  const onClickMax = React.useCallback(() => {
    if (!maxAmount) return;
...
function Output() {
  ...
  const overrideColor = utils.useAtomValue(colorAtom);
...
const Underlayer = styled__default["default"].div(_templateObject$l || (_templateObject$l = _taggedTemplateLiteral__default["default"](["\n  background-color: ", ";\n  border-radius: ", "em;\n  height: 48px;\n  left: 50%;\n  position: absolute;\n  /* Adjust by 2px to account for border display. */\n  transform: translate(-50%, calc(-50% - 2px));\n  width: 48px;\n  z-index: ", ";\n"])), _ref => {
  let {
    theme
  } = _ref;
  return theme.container;
...
const StyledReverseButton = styled__default["default"](Button$1)(_templateObject2$c || (_templateObject2$c = _taggedTemplateLiteral__default["default"](["\n  align-items: center;\n  background-color: ", ";\n  border: 4px solid ", ";\n  border-radius: ", "rem;\n  display: flex;\n  justify-content: center;\n  width: 100%;\n"])), _ref3 => {
  let {
    theme
  } = _ref3;
  return theme.module;
...
var _templateObject$k;
const optionCss = selected => styled.css(_templateObject$k || (_templateObject$k = _taggedTemplateLiteral__default["default"](["\n  border: 1px solid ", ";\n  border-radius: ", "rem;\n  color: ", " !important;\n  display: grid;\n  grid-gap: 0.25rem;\n  padding: calc(0.75rem - 1px) 0.625rem;\n\n  :enabled {\n    border: 1px solid ", ";\n  }\n\n  :enabled:hover {\n    border-color: ", ";\n  }\n\n  :enabled:focus-within {\n    border-color: ", ";\n  }\n"])), _ref => {
  let {
    theme
  } = _ref;
...
function Label$1(_ref8) {
  ...
  return /*#__PURE__*/React__default["default"].createElement(Row, {
    ...
    placement: "top",
    contained: true,
    icon: /*#__PURE__*/React__default["default"].createElement(reactFeather.Info, {
      style: {
        height: '100%'
      }
    })
...
const Button = styled__default["default"](TextButton)(_templateObject$j || (_templateObject$j = _taggedTemplateLiteral__default["default"](["\n  ", "\n  display: flex;\n  flex-grow: 1;\n  max-width: 180px;\n"])), _ref => {
  let {
    selected
  } = _ref;
  return optionCss(selected);
});
const Custom = styled__default["default"](BaseButton)(_templateObject2$b || (_templateObject2$b = _taggedTemplateLiteral__default["default"](["\n  ", "\n  ", "\n  display: flex;\n  flex-grow: 1;\n  max-width: 180px;\n  * input {\n    text-align: right;\n  }\n"])), _ref2 => {
  let {
    selected
  } = _ref2;
  return optionCss(selected);
}, inputCss);
const ExpandoContentRow = styled__default["default"](Row)(_templateObject3$8 || (_templateObject3$8 = _taggedTemplateLiteral__default["default"](["\n  margin: 1rem 0 0;\n"])));
const Option = /*#__PURE__*/React.forwardRef(function Option(_ref3, ref) {
  let {
    wrapper: Wrapper,
    children,
    selected,
...
const Warning = /*#__PURE__*/React.memo(function Warning(_ref4) {
  let {
    state,
    showTooltip
  } = _ref4;
...
function MaxSlippageSelect() {
  ...
  const [slippage, setSlippageBase] = jotai.useAtom(slippageAtom);
  const setSlippage = React.useCallback(update => {
  ...
  const setAutoSlippage = React.useCallback(() => {
    setSlippage({
      auto: true,
      max: undefined
    });
  }, [setSlippage]);
  const [maxSlippageInput, setMaxSlippageInput] = React.useState(((_slippage$max = slippage.max) === null || _slippage$max === void 0 ? void 0 : _slippage$max.toString()) || '');
  ...
  const [warning, setWarning] = React.useState(getSlippageWarning(toPercent(slippage.max)));
  React.useEffect(() => {
    var _slippage$max2;
  ...
  const processInput = React.useCallback(max => {
...
const Input$1 = styled__default["default"].input(_templateObject$i || (_templateObject$i = _taggedTemplateLiteral__default["default"](["\n  -moz-appearance: none;\n  -webkit-appearance: none;\n  align-items: center;\n  appearance: none;\n  background: ", ";\n  border: none;\n  border-radius: ", "rem;\n  cursor: pointer;\n  display: flex;\n  font-size: inherit;\n  font-weight: inherit;\n  height: 2rem;\n  margin: 0;\n  padding: 0;\n\n  position: relative;\n  width: 3.5rem;\n\n  :before {\n    background-color: ", ";\n    border-radius: ", "%;\n    content: '';\n    display: inline-block;\n    height: 1.5rem;\n    margin-left: 0.25rem;\n    position: absolute;\n    width: 1.5rem;\n  }\n\n  :hover:before {\n    background-color: ", ";\n  }\n\n  :checked:before {\n    background-color: ", ";\n    margin-left: 1.75rem;\n  }\n\n  :hover:checked:before {\n    background-color: ", ";\n  }\n\n  :checked:after {\n    margin-left: 0;\n  }\n\n  :before {\n    transition: margin ", " ease;\n  }\n"])), _ref => {
  let {
    theme
  } = _ref;
  return theme.interactive;
...
function RouterPreferenceToggle() {
  ...
  const [routerPreference, setRouterPreferenceBase] = jotai.useAtom(routerPreferenceAtom);
  const setRouterPreference = React.useCallback(update => {
...
const Input = styled__default["default"](Row)(_templateObject$h || (_templateObject$h = _taggedTemplateLiteral__default["default"](["\n  ", ";\n\n  background-color: transparent;\n  max-width: 360px;\n\n  input {\n    text-align: right;\n  }\n"])), inputCss);
const InputContainer = styled__default["default"](Row)(_templateObject2$a || (_templateObject2$a = _taggedTemplateLiteral__default["default"](["\n  gap: 0.5rem;\n  margin: 1rem 0 0;\n"])));
const TtlValue = styled__default["default"].div(_templateObject3$7 || (_templateObject3$7 = _taggedTemplateLiteral__default["default"](["\n  // set min width here to prevent entire popover layout from shrinking when\n  // user deletes text in ttl input\n  min-width: 3rem;\n  text-align: right;\n"])));
...
const SettingsColumn = styled__default["default"](Column)(_templateObject$g || (_templateObject$g = _taggedTemplateLiteral__default["default"](["\n  margin: 0.5rem 0.25rem;\n"])));
function SettingsMenu() {
  const [routerUrl] = jotai.useAtom(swapRouterUrlAtom);
...
var _templateObject$f;
const StyledExternalLink = styled__default["default"](ExternalLink)(_templateObject$f || (_templateObject$f = _taggedTemplateLiteral__default["default"](["\n  color: ", ";\n  text-decoration: none;\n"])), _ref => {
  let {
    theme,
    color
  } = _ref;
...
function EtherscanLink(_ref2) {
  ...
  const url = React.useMemo(() => data && getExplorerLink(chainId || SupportedChainId.XRPL_EVM_TESTNET, data, type), [chainId, data, type]);
...
const SpeedBumpWrapper = styled__default["default"](Column)(_templateObject$e || (_templateObject$e = _taggedTemplateLiteral__default["default"](["\n  align-items: stretch;\n  display: flex;\n  height: 100%;\n  justify-content: space-between;\n  max-width: 420px;\n  padding: 1rem;\n  text-align: center;\n"])));
const BodyText = styled__default["default"](Body1)(_templateObject2$8 || (_templateObject2$8 = _taggedTemplateLiteral__default["default"](["\n  padding: 0 0.5rem;\n"])));
const IconWrapper = styled__default["default"].div(_templateObject3$6 || (_templateObject3$6 = _taggedTemplateLiteral__default["default"](["\n  padding: 2rem;\n"])));
const SpeedbumpButtonStyle = styled.css(_templateObject4$4 || (_templateObject4$4 = _taggedTemplateLiteral__default["default"](["\n  border-radius: 1rem;\n  padding: 1rem;\n"])));
const HeaderRow = styled__default["default"](Row)(_templateObject5$3 || (_templateObject5$3 = _taggedTemplateLiteral__default["default"](["\n  width: 100%;\n"])));
const XButtonWrapper = styled__default["default"].button(_templateObject6$3 || (_templateObject6$3 = _taggedTemplateLiteral__default["default"](["\n  background: none;\n  border: none;\n  padding: 0.25rem;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  cursor: pointer;\n"])));
const ContinueButton = styled__default["default"](Button$1)(_templateObject7$3 || (_templateObject7$3 = _taggedTemplateLiteral__default["default"](["\n  ", "\n  background-color: ", ";\n  color: ", ";\n"])), SpeedbumpButtonStyle, _ref => {
  let {
    theme
  } = _ref;
...
const CancelButton = styled__default["default"](TextButton)(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral__default["default"](["\n  ", "\n  color: ", ";\n"])), SpeedbumpButtonStyle, _ref3 => {
  let {
    theme
  } = _ref3;
  return theme.secondary;
...
function SpeedBumpDialog(_ref4) {
  ...
  return /*#__PURE__*/React__default["default"].createElement(SpeedBumpWrapper, null, /*#__PURE__*/React__default["default"].createElement(Column, {
    ...
    align: "center",
    justify: "flex-end"
  }, /*#__PURE__*/React__default["default"].createElement(XButtonWrapper, {
    onClick: onClose,
    "aria-label": "Close"
...
function useTradeExchangeRate(trade, outputUSDC) {
  ...
  return React.useMemo(() => ["".concat(1, " ", price.baseCurrency.symbol, " = ").concat(format.formatPrice(price, format.NumberType.TokenTx), " ").concat(price.quoteCurrency.symbol), usdcPrice && format.formatCurrencyAmount(usdcPrice, format.NumberType.FiatTokenPrice)], [price, usdcPrice]);
}
...
function Price(_ref) {
  ...
  const [defaultBase, setDefaultBase] = React.useState(false);
  const onClick = React.useCallback(() => setDefaultBase(!defaultBase), [defaultBase]);
...
const StyledEstimate = styled__default["default"](Caption$1)(_templateObject$d || (_templateObject$d = _taggedTemplateLiteral__default["default"](["\n  margin-bottom: 0.5rem;\n  margin-top: 0.5rem;\n  max-height: 3rem;\n"])));
function SwapInputOutputEstimate(_ref) {
  ...
  const {
    estimateMessage
  } = React.useMemo(() => getEstimateMessage(trade, slippage), [slippage, trade]);
...
function getEstimateMessage(trade, slippage) {
  ...
  if (isExactInput(trade.tradeType)) {
    ...
    const localizedMinReceived = format.formatCurrencyAmount(trade.minimumAmountOut(slippage.allowed), format.NumberType.TokenTx);
    ...
    return {
      ...
      descriptor: /*#__PURE__*/React__default["default"].createElement(Body2, null, /*i18n*/i18n._("Minimum output after slippage"), slippage && /*#__PURE__*/React__default["default"].createElement(Body2, {
        $inline: true,
    ...
    const localizedMaxSent = format.formatCurrencyAmount(trade.maximumAmountIn(slippage.allowed), format.NumberType.TokenTx);
    ...
    return {
      ...
      descriptor: /*#__PURE__*/React__default["default"].createElement(Body2, null, /*i18n*/i18n._("Maximum input after slippage"), slippage && /*#__PURE__*/React__default["default"].createElement(Body2, {
        $inline: true,
...
const Label = styled__default["default"].span(_templateObject$c || (_templateObject$c = _taggedTemplateLiteral__default["default"](["\n  color: ", ";\n  margin-right: 0.5rem;\n  max-width: 75%;\n"])), _ref => {
  let {
    theme
  } = _ref;
  return theme.secondary;
});
const Value = styled__default["default"].span(_templateObject2$7 || (_templateObject2$7 = _taggedTemplateLiteral__default["default"](["\n  color: ", ";\n  text-align: end;\n"])), _ref2 => {
  let {
    color,
    theme
  } = _ref2;
...
const DetailValue = styled__default["default"](Value)(_templateObject3$5 || (_templateObject3$5 = _taggedTemplateLiteral__default["default"](["\n  max-width: 45%;\n  overflow-wrap: break-word;\n"])));
const RuleWrapper = styled__default["default"].div(_templateObject4$3 || (_templateObject4$3 = _taggedTemplateLiteral__default["default"](["\n  margin: 0.75rem 0.125rem;\n"])));
...
function Amount(_ref4) {
  ...
  let formattedAmount = format.formatCurrencyAmount(amount, format.NumberType.TokenTx);
...
function Details(_ref5) {
  ...
  const feeOptions = utils.useAtomValue(feeOptionsAtom);
  ...
  const {
    ...
    if (feeOptions) {
      ...
      if (fee.greaterThan(0)) {
        const parsedFee = format.formatCurrencyAmount(fee, format.NumberType.FiatGasPrice);
    ...
    if (gasUseEstimateUSD) {
      details.push([/*i18n*/i18n._("Network fee"), "~".concat(format.formatCurrencyAmount(gasUseEstimateUSD, format.NumberType.FiatGasPrice))]);
    }
    if (impact) {
      details.push([/*i18n*/i18n._("Price impact"), impact !== null && impact !== void 0 && impact.percent ? format.formatPriceImpact(impact === null || impact === void 0 ? void 0 : impact.percent) : '-', impact.warning]);
    }
    const {
      estimateMessage,
      descriptor,
...
const CollapsingColumn = styled__default["default"](Column)(_templateObject$b || (_templateObject$b = _taggedTemplateLiteral__default["default"](["\n  justify-items: ", ";\n"])), _ref => {
  let {
    open
  } = _ref;
...
function Summary(_ref3) {
  ...
  const summaryContents = /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement(TokenValue, {
    input: input,
    usdc: inputUSDC,
    open: open
...
function useReviewState(onSwap, allowance, doesTradeDiffer) {
  const [currentState, setCurrentState] = React.useState(ReviewState.REVIEWING);
  const closeDialog = useCloseDialog();
  const onStartSwapFlow = React.useCallback(async () => {
  ...
  const onCancel = React.useCallback(() => setCurrentState(ReviewState.REVIEWING), []);
  return {
    onStartSwapFlow,
    onCancel,
    currentState
...
const Body$1 = styled__default["default"](Column)(_templateObject$a || (_templateObject$a = _taggedTemplateLiteral__default["default"](["\n  margin: 0.75rem 0.875rem;\n"])));
const PriceImpactText = styled__default["default"].span(_templateObject2$6 || (_templateObject2$6 = _taggedTemplateLiteral__default["default"](["\n  color: ", ";\n"])), _ref => {
  let {
    theme
  } = _ref;
  return theme.error;
...
function ConfirmButton(_ref3) {
  ...
  const [ackTrade, setAckTrade] = React.useState(trade);
  const doesTradeDiffer = React.useMemo(() => Boolean(trade && ackTrade && tradeMeaningfullyDiffers(trade, ackTrade, slippage.allowed)), [ackTrade, trade, slippage]);
  ...
  const [shouldRequestApproval, isApprovalLoading] = React.useMemo(() => allowance.state === AllowanceState.REQUIRED ? [allowance.shouldRequestApproval, allowance.isApprovalLoading] : [false, false], [allowance]);
  const onAcknowledgeClick = React.useCallback(() => {
  ...
  const [action, color] = React.useMemo(() => {
    switch (currentState) {
...
function SummaryDialog(props) {
  ...
  const [ackPriceImpact, setAckPriceImpact] = React.useState(false);
  const [showSpeedbump, setShowSpeedbump] = React.useState(((_props$impact = props.impact) === null || _props$impact === void 0 ? void 0 : _props$impact.warning) === 'error');
  const [boundary, setBoundary] = React.useState(null);
  const width = useWindowWidth();
  const isPageCentered = useIsDialogPageCentered();
  const onAcknowledgeSpeedbump = React.useCallback(() => {
    setAckPriceImpact(true);
    setShowSpeedbump(false);
  }, []);
  const triggerImpactSpeedbump = React.useCallback(() => {
    var _props$impact2;
  ...
  }, /*i18n*/i18n._("This transaction will result in a"), ' ', /*#__PURE__*/React__default["default"].createElement(PriceImpactText, null, format.formatPriceImpact((_props$impact5 = props.impact) === null || _props$impact5 === void 0 ? void 0 : _props$impact5.percent), " "), /*i18n*/i18n._("price impact on the market price of this pool. Do you wish to continue?")) : /*#__PURE__*/React__default["default"].createElement(PopoverBoundaryProvider, {
    value: boundary
  }, /*#__PURE__*/React__default["default"].createElement(Header$1, {
    title: /*#__PURE__*/React__default["default"].createElement(Trans, {
      id: "Review swap"
...
const EtherscanLinkContainer = styled__default["default"](Row)(_templateObject$9 || (_templateObject$9 = _taggedTemplateLiteral__default["default"](["\n  padding: 0.5rem 0 1.5rem;\n  transition: opacity ", ";\n  width: 100%;\n  :hover {\n    opacity: 0.6;\n  }\n"])), AnimationSpeed.Medium);
...
const ConnectorsContext = /*#__PURE__*/React.createContext(null);
...
class WalletConnectPopup extends walletconnect.WalletConnect {
  constructor(_ref) {
    let {
      actions,
      options,
...
class WalletConnectQR extends walletconnect.WalletConnect {
  constructor(_ref2) {
    let {
      actions,
      options,
    ...
    this.events.once(walletconnect.URI_AVAILABLE, () => {
      var _this$provider;
      (_this$provider = this.provider) === null || _this$provider === void 0 || _this$provider.connector.on('disconnect', () => {
        this.deactivate();
      });
    });
    this.events.on(walletconnect.URI_AVAILABLE, async uri => {
      this.svg = undefined;
      if (!uri) return;
      this.svg = await QRCode__default["default"].toString(uri, {
...
const Body = styled__default["default"](Column)(_templateObject$8 || (_templateObject$8 = _taggedTemplateLiteral__default["default"](["\n  display: grid;\n  gap: 12px;\n  grid-template-columns: repeat(2, calc(50% - 0.5rem / 2));\n  grid-template-rows: 2fr 1fr;\n  height: calc(100% - 2.5rem);\n"])));
const StyledButtonContents = styled__default["default"](Column)(_templateObject2$5 || (_templateObject2$5 = _taggedTemplateLiteral__default["default"](["\n  gap: 0.75rem;\n  justify-items: center;\n"])));
const StyledMainButton = styled__default["default"](Button$1)(_templateObject3$4 || (_templateObject3$4 = _taggedTemplateLiteral__default["default"](["\n  border-radius: ", "rem;\n  grid-column: 1 / 3;\n  height: 100%;\n  padding: 22px;\n"])), _ref => {
  let {
    theme
  } = _ref;
  return theme.borderRadius.medium;
});
const StyledMainButtonRow = styled__default["default"](Row)(_templateObject4$2 || (_templateObject4$2 = _taggedTemplateLiteral__default["default"](["\n  grid-template-columns: repeat(2, calc(50% - 1rem / 2));\n  justify-items: center;\n"])));
const StyledSmallButton = styled__default["default"](Button$1)(_templateObject5$2 || (_templateObject5$2 = _taggedTemplateLiteral__default["default"](["\n  border-radius: ", "rem;\n  height: 88px;\n  padding: 16px;\n"])), _ref2 => {
  let {
    theme
  } = _ref2;
  return theme.borderRadius.medium;
});
const StyledNoWalletText = styled__default["default"](Subhead1)(_templateObject6$2 || (_templateObject6$2 = _taggedTemplateLiteral__default["default"](["\n  line-height: 20px;\n  white-space: pre-wrap;\n"])));
const QRCodeWrapper = styled__default["default"].div(_templateObject7$2 || (_templateObject7$2 = _taggedTemplateLiteral__default["default"](["\n  height: 110px;\n  width: 110px;\n  path {\n    /* Maximize contrast: transparent in light theme, otherwise hard-coded to light theme. */\n    fill: ", ";\n  }\n"])), _ref3 => {
  let {
    theme
  } = _ref3;
...
function WalletConnectButton(_ref5) {
  ...
  const [svg, setSvg] = React.useState(walletConnect.svg);
  React.useEffect(() => {
...
function ConnectWalletDialog() {
  ...
  const onActivate = React.useCallback(async connector => {
    try {
...
const onConnectWalletClickAtom = jotai.atom(undefined);
...
function ConnectWalletButton() {
  ...
  const onConnectWalletClick = useConditionalHandler(utils.useAtomValue(onConnectWalletClickAtom));
...
function useENSAddress(ensName) {
  ...
  const ensNodeArgument = React.useMemo(() => [!debouncedName ? undefined : utils$1.namehash(debouncedName)], [debouncedName]);
...
function useENSName(address) {
  ...
  const ensNodeArgument = React.useMemo(() => {
    ...
    return [require$$1.namehash("".concat(debouncedAddress.toLowerCase().substr(2), ".addr.reverse"))];
  }, [debouncedAddress]);
  const registrarContract = useENSRegistrarContract(false);
  const resolverAddress = useSingleCallResult(registrarContract, 'resolver', ensNodeArgument);
  const resolverAddressResult = (_resolverAddress$resu = resolverAddress.result) === null || _resolverAddress$resu === void 0 ? void 0 : _resolverAddress$resu[0];
...
const ERC20_INTERFACE = new abi$1.Interface([{
  constant: false,
  inputs: [{
    name: '_spender',
    type: 'address'
...
function useSwapCallArguments(trade, allowedSlippage, recipientAddressOrName, signatureData, deadline, feeOptions) {
  ...
  return React.useMemo(() => {
    ...
    const {
      value,
      calldata
    } = routerSdk.SwapRouter.swapCallParameters(trade, swapOptions);
...
function useUniversalRouterSwapCallback(trade, options) {
  ...
  const swapCallback = React.useCallback(() => WidgetPromise.from(async () => {
    ...
    const {
      calldata: data,
      value
    } = universalRouterSdk.SwapRouter.swapERC20CallParameters(trade, {
    ...
    const response = await index.sendTransaction(provider, tx, TX_GAS_MARGIN);
  ...
  const args = React.useMemo(() => trade && {
    trade
  }, [trade]);
...
function useOnSubmit() {
  const addTransactionInfo = useAddTransactionInfo();
  const setDisplayTxHash = utils.useUpdateAtom(displayTxHashAtom);
  const [, setInputAmount] = useSwapAmount(Field.INPUT);
  return React.useCallback(async submit => {
...
function SwapButton(_ref) {
  ...
  React.useEffect(() => setOpen(open => trade ? open : false), [trade]);
  // Close the review modal on chain change.
  React.useEffect(() => setOpen(false), [chainId]);
  ...
  const onReviewSwapClick = useConditionalHandler(utils.useAtomValue(swapEventHandlersAtom).onReviewSwapClick);
...
const onSwitchChainAtom = jotai.atom(undefined);
...
function useSwitchChain() {
  ...
  const connectors = useConnectors();
  const onSwitchChain = utils.useAtomValue(onSwitchChainAtom);
  return React.useCallback(async chainId => {
...
function ChainSwitchButton(_ref) {
  ...
  const throwError = useAsyncError();
  const onSwitchChain = React.useCallback(async () => {
    setIsPending(true);
    try {
...
function WrapButton(_ref) {
  ...
  React.useEffect(() => setIsPending(false), [wrapCallback]);
  const native = useNativeCurrency();
  const inputCurrency = wrapType === TransactionType.WRAP ? native : native.wrapped;
  const onSubmit = useOnSubmit();
  const throwAsync = useAsyncError();
  const onWrap = React.useCallback(async () => {
    setIsPending(true);
    try {
  ...
  const actionProps = React.useMemo(() => isPending ? {
    action: {
      message: /*#__PURE__*/React__default["default"].createElement(Trans, {
        id: "Confirm in your wallet"
      }),
...
function SwapActionButton() {
  ...
  const isWrap = useIsWrap();
  const permit2Enabled = usePermit2();
  const isDisabled = React.useMemo(() => !permit2Enabled && approval.state !== SwapApprovalState.APPROVED || error !== undefined || !isWrap && !trade || !inputCurrencyAmount ||
...
const SvgDotLine = props => /*#__PURE__*/React__default["default"].createElement("svg", _extends({
  width: "100%",
  height: 35,
...
const StyledAutoRouterLabel = styled__default["default"](ButtonSmall)(_templateObject$7 || (_templateObject$7 = _taggedTemplateLiteral__default["default"](["\n  @supports (-webkit-background-clip: text) and (-webkit-text-fill-color: transparent) {\n    background-image: linear-gradient(90deg, #2172e5 0%, #54e521 163.16%);\n    -webkit-background-clip: text;\n    -webkit-text-fill-color: transparent;\n  }\n"])));
...
const AutoRouterHeader = /*#__PURE__*/React.forwardRef(function AutoRouterHeader(props, ref) {
  return /*#__PURE__*/React__default["default"].createElement(Row, _extends__default["default"]({
    justify: "left",
    gap: 0.25,
    ref: ref
  }, omit(props, ['color'])), /*#__PURE__*/React__default["default"].createElement(AutoRouter, null), /*#__PURE__*/React__default["default"].createElement(StyledAutoRouterLabel, {
    color: "primary",
    lineHeight: '16px'
...
const Dots = styled__default["default"](SvgDotLine)(_templateObject2$4 || (_templateObject2$4 = _taggedTemplateLiteral__default["default"](["\n  color: ", ";\n  position: absolute;\n  z-index: ", ";\n"])), _ref => {
  let {
    theme
  } = _ref;
  return theme.outline;
}, Layer.UNDERLAYER);
const RouteRow = styled__default["default"](Row)(_templateObject3$3 || (_templateObject3$3 = _taggedTemplateLiteral__default["default"](["\n  flex-wrap: nowrap;\n  margin: 0 0.5rem;\n  position: relative;\n"])));
const GasEstimateRow = styled__default["default"](Row)(_templateObject4$1 || (_templateObject4$1 = _taggedTemplateLiteral__default["default"](["\n  border-top: 1px solid ", ";\n  max-width: 350px;\n  padding: 0.5rem 0 0;\n"])), _ref2 => {
  let {
    theme
  } = _ref2;
  return theme.outline;
});
const RouteNode = styled__default["default"](Row)(_templateObject5$1 || (_templateObject5$1 = _taggedTemplateLiteral__default["default"](["\n  background-color: ", ";\n  border-radius: ", ";\n  margin-left: 0.5rem;\n  padding: 0.25rem;\n  width: max-content;\n"])), _ref3 => {
  let {
    theme
  } = _ref3;
  return theme.module;
...
const RouteBadge = styled__default["default"].div(_templateObject6$1 || (_templateObject6$1 = _taggedTemplateLiteral__default["default"](["\n  background-color: ", ";\n  border-radius: ", ";\n  padding: 0.25rem;\n"])), _ref5 => {
  let {
    theme
  } = _ref5;
  return theme.interactive;
...
const RoutePool = styled__default["default"](RouteNode)(_templateObject7$1 || (_templateObject7$1 = _taggedTemplateLiteral__default["default"](["\n  margin: 0 0.75rem;\n  padding: 0.25rem;\n"])));
function Pool(_ref8) {
  let {
    originCurrency,
    targetCurrency,
...
function RoutingDiagram(_ref1) {
  ...
  const routes = React.useMemo(() => getTokenPath(trade), [trade]);
  return /*#__PURE__*/React__default["default"].createElement(Column, {
    gap: 0.75,
    padding: "0.5rem"
  }, !hideHeader && /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement(AutoRouterHeader, null), /*#__PURE__*/React__default["default"].createElement(Rule, null)), routes.map((route, index) => /*#__PURE__*/React__default["default"].createElement(Route, {
    key: index,
    route: route
...
function GasEstimateTooltip(_ref) {
  ...
  const showTooltip = useTooltip(tooltip);
  const [open, setOpen] = React.useState(false);
  const displayEstimate = format.formatCurrencyAmount(gasUseEstimateUSD, format.NumberType.FiatGasPrice);
...
const Loading = styled__default["default"].span(_templateObject$6 || (_templateObject$6 = _taggedTemplateLiteral__default["default"](["\n  color: ", ";\n  ", ";\n"])), _ref => {
  let {
    theme
  } = _ref;
  return theme.secondary;
}, loadingCss);
const CaptionRow$1 = styled__default["default"](Row)(_templateObject2$3 || (_templateObject2$3 = _taggedTemplateLiteral__default["default"](["\n  align-items: center;\n  flex-shrink: ", ";\n  gap: ", "rem;\n  height: 100%;\n"])), _ref2 => {
  let {
    shrink
  } = _ref2;
...
const ExpandIcon = styled__default["default"](reactFeather.ChevronDown)(_templateObject3$2 || (_templateObject3$2 = _taggedTemplateLiteral__default["default"](["\n  color: ", ";\n  cursor: pointer;\n  transform: ", ";\n  transition: transform ", ";\n\n  :hover {\n    opacity: 0.6;\n  }\n"])), _ref4 => {
  let {
    theme
  } = _ref4;
  return theme.secondary;
...
function Caption(_ref6) {
  ...
  return /*#__PURE__*/React__default["default"].createElement(CaptionRow$1, {
    ...
    icon: Icon ? /*#__PURE__*/React__default["default"].createElement(LargeIcon, {
      icon: Icon,
      color: color
    }) : undefined
    ...
    icon: Icon,
    color: color
  }) : null, /*#__PURE__*/React__default["default"].createElement(Body2, {
    color: color
  }, caption));
}
function Connecting() {
  return /*#__PURE__*/React__default["default"].createElement(Caption, {
    caption: /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement(Spinner, null), /*#__PURE__*/React__default["default"].createElement(Loading, null, /*#__PURE__*/React__default["default"].createElement(Trans, {
      id: "Connecting\u2026"
    })))
  });
}
...
function Wrap(_ref8) {
  ...
  const isWideWidget = useIsWideWidget();
  const Text = React.useCallback(() => isWideWidget ? /*#__PURE__*/React__default["default"].createElement(Trans, {
...
function Expander(_ref9) {
  ...
  return /*#__PURE__*/React__default["default"].createElement(ExpandIcon, {
    $expanded: expanded
  });
}
...
const OrderRoutingRow = styled__default["default"](Row)(_templateObject$5 || (_templateObject$5 = _taggedTemplateLiteral__default["default"](["\n  height: ", "rem;\n  margin: 0 1rem;\n  padding: ", "rem 0;\n"])), ORDER_ROUTING_HEIGHT_REM, CONTAINER_VERTICAL_PADDING_REM);
...
const TradeSummaryColumn = styled__default["default"](Column)(_templateObject$4 || (_templateObject$4 = _taggedTemplateLiteral__default["default"](["\n  border-bottom: 1px solid ", ";\n  border-top: 1px solid ", ";\n  margin: 0 1rem;\n  padding: ", "rem 0;\n"])), _ref => {
  let {
    theme
  } = _ref;
  return theme.outline;
...
const TradeAttributeName = styled__default["default"](Body2)(_templateObject2$2 || (_templateObject2$2 = _taggedTemplateLiteral__default["default"](["\n  color: ", ";\n"])), _ref3 => {
  let {
    theme,
    color
  } = _ref3;
...
const TradeAttributeValue = styled__default["default"](Body2)(_templateObject3$1 || (_templateObject3$1 = _taggedTemplateLiteral__default["default"](["\n  color: ", ";\n"])), _ref4 => {
  let {
    theme,
    color
  } = _ref4;
...
function SummaryRow(_ref5) {
  ...
  return /*#__PURE__*/React__default["default"].createElement(Row, null, nameTooltip ? /*#__PURE__*/React__default["default"].createElement(Row, {
    ...
    icon: /*#__PURE__*/React__default["default"].createElement(valueTooltip.icon, {
      color: color
    }),
    placement: "auto"
...
function ToolbarTradeSummary(_ref6) {
  ...
  }, rows.map((row, i) => /*#__PURE__*/React__default["default"].createElement(SummaryRow, _extends__default["default"]({
    key: i
  }, row))));
}

var _templateObject$3, _templateObject2$1;
const StyledExpando = styled__default["default"](Expando)(_templateObject$3 || (_templateObject$3 = _taggedTemplateLiteral__default["default"](["\n  border: 1px solid ", ";\n  border-radius: ", "rem;\n  overflow: hidden;\n"])), _ref => {
  let {
    theme
  } = _ref;
  return theme.outline;
...
const ToolbarRow = styled__default["default"](Row)(_templateObject2$1 || (_templateObject2$1 = _taggedTemplateLiteral__default["default"](["\n  cursor: ", ";\n  flex-wrap: nowrap;\n  gap: 0.5rem;\n  height: ", "rem;\n  padding: 0 1rem;\n"])), _ref3 => {
  let {
    isExpandable
  } = _ref3;
...
function CaptionRow() {
  ...
  const maybeToggleOpen = React.useCallback(() => {
    if (isExpandable) {
      onToggleOpen();
    }
  }, [isExpandable, onToggleOpen]);
  const tradeSummaryRows = React.useMemo(() => {
...
function Swap(props) {
  ...
  const [wrapper, setWrapper] = React.useState(null);
  const [displayTxHash, setDisplayTxHash] = jotai.useAtom(displayTxHashAtom);
  const pendingTxs = usePendingTransactions();
  const displayTx = React.useMemo(() => displayTxHash && pendingTxs[displayTxHash], [displayTxHash, pendingTxs]);
...
function useSyncWidgetEventHandlers(_ref) {
  ...
  const setOnConnectWalletClick = utils.useUpdateAtom(onConnectWalletClickAtom);
  React.useEffect(() => {
    setOnConnectWalletClick(() => onConnectWalletClick);
  }, [onConnectWalletClick, setOnConnectWalletClick]);
  const setOnSwitchChain = utils.useUpdateAtom(onSwitchChainAtom);
  React.useEffect(() => {
...
class JsonRpcConnector extends types.Connector {
  constructor(_ref) {
    let {
      actions,
      provider,
...
const JsonRpcUrlMapContext = /*#__PURE__*/React.createContext(undefined);
...
function initializeWeb3ReactConnector(Constructor, options) {
  const [connector, hooks] = core.initializeConnector(actions => new Constructor(_objectSpread({
    actions
  }, options)));
...
function useWeb3ReactConnectors(_ref3) {
  ...
  const [urlMap, connectionMap] = React.useMemo(() => [toJsonRpcUrlMap(jsonRpcUrlMap), toJsonRpcConnectionMap(jsonRpcUrlMap)], [jsonRpcUrlMap]);
  const throwAsync = useAsyncError();
  ...
  const metaMask = React.useMemo(() => initializeWeb3ReactConnector(metamask.MetaMask, {
    onError: () => {
      throwAsync(new MetaMaskConnectionError());
    }
  }), [throwAsync]);
  const walletConnect = React.useMemo(() => initializeWeb3ReactConnector(WalletConnectPopup, {
    options: {
      rpc: urlMap
    },
    defaultChainId,
  ...
  const walletConnectQR = React.useMemo(() => initializeWeb3ReactConnector(WalletConnectQR, {
    options: {
      rpc: urlMap
    },
    defaultChainId,
  ...
  const network$1 = React.useMemo(() => initializeWeb3ReactConnector(network.Network, {
...
async function dynamicActivate(locale) {
  ...
  try {
    const catalog = await (function (t) { return Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require(t)); }); })("./locales/".concat(locale, ".js"));
...
function Provider(_ref2) {
  ...
  const processedLocale = React.useMemo(() => {
...
const StyledWidgetWrapper = styled__default["default"].div(_templateObject$2 || (_templateObject$2 = _taggedTemplateLiteral__default["default"](["\n  -webkit-tap-highlight-color: rgba(0, 0, 0, 0);\n  background-color: ", ";\n  border: ", ";\n  border-radius: ", "rem;\n  box-shadow: ", ";\n  box-sizing: border-box;\n  display: flex;\n  flex-direction: column;\n\n  max-width: 600px;\n  min-height: 300px;\n  min-width: 300px;\n  padding: ", "px;\n  position: relative;\n  user-select: none;\n  width: ", ";\n\n  * {\n    box-sizing: border-box;\n  }\n\n  ", ";\n"])), _ref => {
  let {
    theme
  } = _ref;
  return theme.container;
...
function WidgetWrapper(props) {
   ...
   */
  const ref = React.useRef(null);
  const [wrapperWidth, setWidgetWidth] = React.useState(toLength(initialWidth) === initialWidth ? 360 // If the initial width is a string, use default width until the ResizeObserver gives us the true width as a number.
  : initialWidth);
  React.useEffect(() => {
    const observer = new ResizeObserver__default["default"](entries => {
...
const DialogWrapper = styled__default["default"].div(_templateObject$1 || (_templateObject$1 = _taggedTemplateLiteral__default["default"](["\n  border-radius: ", "rem;\n  height: 100%;\n  left: 0;\n  padding: 0.5rem;\n  position: absolute;\n  top: 0;\n  width: 100%;\n"])), _ref => {
  let {
    theme
  } = _ref;
  return theme.borderRadius.large;
...
function Widget(props) {
  const [dialog, setDialog] = React.useState(props.dialog || null);
...
const LoadingWrapper = styled__default["default"].div(_templateObject || (_templateObject = _taggedTemplateLiteral__default["default"](["\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n"])));
const Blob = styled__default["default"].div(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral__default["default"](["\n  background-color: ", ";\n  border-radius: ", ";\n  height: ", ";\n  width: ", ";\n"])), _ref => {
  let {
    isModule,
    theme
  } = _ref;
...
const WideColumn = styled__default["default"](Column)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral__default["default"](["\n  width: 100%;\n"])));
const TitleColumn = styled__default["default"](Column)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral__default["default"](["\n  padding: 0.5rem;\n  padding-bottom: 1.25rem;\n  width: 100%;\n"])));
const InputColumn = styled__default["default"](Column)(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral__default["default"](["\n  background-color: ", ";\n  border-radius: ", "rem;\n  display: flex;\n  gap: 1.875rem;\n  margin-bottom: 0.25rem;\n  padding: 0.75rem;\n  padding-bottom: 3.25rem;\n  padding-top: 3.25rem;\n"])), _ref5 => {
  let {
    theme
  } = _ref5;
  return theme.module;
...
const OutputColumn = styled__default["default"](InputColumn)(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral__default["default"](["\n  padding-bottom: 3rem;\n  padding-top: 3.5rem;\n"])));
const ButtonColumn = styled__default["default"](Column)(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral__default["default"](["\n  padding-bottom: 0rem;\n  padding-top: 0.55rem;\n  width: 100%;\n"])));
